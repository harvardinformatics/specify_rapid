...
class huh_taxontreedef implements  model , loadableModel, saveableModel, tableSchema 
{
...
*/
   ...
   private $TaxonTreeDefID; // PK INTEGER 
   ...
   private $loaded;
   private $error;
   const FIELDLIST = ' TaxonTreeDefID, TimestampCreated, TimestampModified, Version, FullNameDirection, Name, Remarks, ModifiedByAgentID, CreatedByAgentID, ';
   const PKFIELDLIST = ' TaxonTreeDefID, ';
   const NUMBER_OF_PRIMARY_KEYS = 1;
   private $primaryKeyArray = array( 1 => 'TaxonTreeDefID'  ) ;
   private $allFieldsArray = array( 0 => 'TaxonTreeDefID' , 1 => 'TimestampCreated' , 2 => 'TimestampModified' , 3 => 'Version' , 4 => 'FullNameDirection' , 5 => 'Name' , 6 => 'Remarks' , 7 => 'ModifiedByAgentID' , 8 => 'CreatedByAgentID'  ) ;
   private $selectDistinctFieldsArray = array( 7 => 'ModifiedByAgentID' , 8 => 'CreatedByAgentID'  ) ;

   //---------------------------------------------------------------------------

   // constructor 
   function huh_taxontreedef(){
...
/*TaxonTreeDefID*/
   ...
   public function setTaxonTreeDefID($TaxonTreeDefID) {
       if (strlen(preg_replace('/[^0-9]/','',$TaxonTreeDefID)) > huh_taxontreedef::TAXONTREEDEFID_SIZE) { 
...
/*TimestampCreated*/
   ...
   public function setTimestampCreated($TimestampCreated) {
       if (strlen($TimestampCreated) > huh_taxontreedef::TIMESTAMPCREATED_SIZE) { 
...
/*TimestampModified*/
   ...
   public function setTimestampModified($TimestampModified) {
       if (strlen($TimestampModified) > huh_taxontreedef::TIMESTAMPMODIFIED_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Version*/
   ...
   public function setVersion($Version) {
       if (strlen(preg_replace('/[^0-9]/','',$Version)) > huh_taxontreedef::VERSION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*FullNameDirection*/
   ...
   public function setFullNameDirection($FullNameDirection) {
       if (strlen(preg_replace('/[^0-9]/','',$FullNameDirection)) > huh_taxontreedef::FULLNAMEDIRECTION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*Name*/
   ...
   public function setName($Name) {
       if (strlen($Name) > huh_taxontreedef::NAME_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Remarks*/
   ...
   public function setRemarks($Remarks) {
       if (strlen($Remarks) > huh_taxontreedef::REMARKS_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*ModifiedByAgentID*/
   ...
   public function setModifiedByAgentID($ModifiedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$ModifiedByAgentID)) > huh_taxontreedef::MODIFIEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*CreatedByAgentID*/
   ...
   public function setCreatedByAgentID($CreatedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$CreatedByAgentID)) > huh_taxontreedef::CREATEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
   ...
   public function PK() { // get value of primary key 
        $returnvalue = '';
        $returnvalue .= $this->getTaxonTreeDefID();
        return $returnvalue;
   }
   public function PKArray() { // get name and value of primary key fields 
        $returnvalue = array();
        $returnvalue['TaxonTreeDefID'] = $this->getTaxonTreeDefID();
        return $returnvalue;
   }
  ...
  const C_CreatedByAgentIDMYSQLI_TYPE = 'i';
   ...
   public function load($pk) {
        ...
        try {
             if (is_array($pk)) { 
                 $this->setTaxonTreeDefID($pk[TaxonTreeDefID]);
             } else { ;
                 $this->setTaxonTreeDefID($pk);
             };
        } 
        catch (Exception $e) { 
        ...
        if($this->TaxonTreeDefID != NULL) {
           $sql = 'SELECT TaxonTreeDefID, TimestampCreated, TimestampModified, Version, FullNameDirection, Name, Remarks, ModifiedByAgentID, CreatedByAgentID FROM taxontreedef WHERE TaxonTreeDefID = '.$this->TaxonTreeDefID ;

           $preparesql = 'SELECT TaxonTreeDefID, TimestampCreated, TimestampModified, Version, FullNameDirection, Name, Remarks, ModifiedByAgentID, CreatedByAgentID FROM taxontreedef WHERE TaxonTreeDefID = ? ';

           if ($statement = $connection->prepare($preparesql)) { 
              $statement->bind_param("i", $this->TaxonTreeDefID);
              $statement->execute();
              $statement->bind_result($this->TaxonTreeDefID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->FullNameDirection, $this->Name, $this->Remarks, $this->ModifiedByAgentID, $this->CreatedByAgentID);
              $statement->fetch();
              $statement->close();
           }
   ...
   public function save() {
        ...
        if ($this->TaxonTreeDefID!= NULL) {
            ...
            $sql .= "  WHERE TaxonTreeDefID = ? ";
        } else {
            $sql  = 'INSERT INTO taxontreedef ';
            $isInsert = true;
if ($this->PK==NULL) { throw new Exception('Can\'t insert record with null primary key for this table'); }
            $sql .= '( TaxonTreeDefID ,  TimestampCreated ,  TimestampModified ,  Version ,  FullNameDirection ,  Name ,  Remarks ,  ModifiedByAgentID ,  CreatedByAgentID ) VALUES (';
            $sql .=  "  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
        ...
        if ($statement = $connection->prepare($sql)) { 
           if ($this->TaxonTreeDefID!= NULL ) {
              $statement->bind_param("issiissiii", $this->TaxonTreeDefID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->FullNameDirection , $this->Name , $this->Remarks , $this->ModifiedByAgentID , $this->CreatedByAgentID , $this->TaxonTreeDefID );
           } else { 
              $statement->bind_param("issiissii", $this->TaxonTreeDefID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->FullNameDirection , $this->Name , $this->Remarks , $this->ModifiedByAgentID , $this->CreatedByAgentID );
           } 
           $statement->execute();
   ...
   public function delete() {
        ...
        if($this->TaxonTreeDefID != NULL) {
           ...
           $preparedsql = 'SELECT  FROM taxontreedef WHERE  and TaxonTreeDefID = ?  ' ;
        if ($statement = $connection->prepare($preparedsql)) { 
           $statement->bind_param("issiissii", $this->TaxonTreeDefID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->FullNameDirection, $this->Name, $this->Remarks, $this->ModifiedByAgentID, $this->CreatedByAgentID);
           $statement->execute();
           $statement->store_result();
           if ($statement->num_rows()==1) {
                $sql = 'DELETE FROM taxontreedef WHERE  and TaxonTreeDefID = ?  ';
                if ($stmt_delete = $connection->prepare($sql)) { 
                   $stmt_delete->bind_param("issiissii", $this->TaxonTreeDefID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->FullNameDirection, $this->Name, $this->Remarks, $this->ModifiedByAgentID, $this->CreatedByAgentID);
   ...
   public function count() {
        ...
        global $connection;
        $returnvalue = false;
        $sql = 'SELECT count(*)  FROM taxontreedef';
   ...
   public function loadArrayKeyValueSearch($searchTermArray) {
       ...
       $sql = "SELECT TaxonTreeDefID FROM taxontreedef $wherebit";
       if ($wherebit=='') { 
...
// TODO: *************** link to related tables 
  ...
  public function loadLinkedTo() { 
   ...
   public function keySelectAllConcatJSON($orderby='ASC') {
       ...
       $sql = "SELECT TaxonTreeDefID, concat(IFNULL(TimestampCreated,'') || ' ' || IFNULL(TimestampModified,'') || ' ' || IFNULL(Version,'') || ' ' || IFNULL(FullNameDirection,'') || ' ' || IFNULL(Name,'') || ' ' || IFNULL(Remarks,'') || ' ' || IFNULL(ModifiedByAgentID,'') || ' ' || IFNULL(CreatedByAgentID,'')) FROM taxontreedef order by ModifiedByAgentID, CreatedByAgentID $order ";
       $comma = '';
       if ($result = $connection->query($sql)) { 
   ...
   public function keySelectDistinctJSON($field,$orderby='ASC') {
       ...
       if ($this->hasField($field)) { 
          ...
          if ($orderby=='ASC') { $order = 'ASC'; } else { $order = 'DESC'; } 
          $preparemysql = "SELECT DISTINCT $fieldesc FROM taxontreedef order by $fieldesc $order ";
          $comma = '';
   ...
   public function loadArrayByModifiedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT TaxonTreeDefID FROM taxontreedef WHERE ModifiedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT TaxonTreeDefID FROM taxontreedef WHERE ModifiedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
   ...
   public function loadArrayByCreatedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT TaxonTreeDefID FROM taxontreedef WHERE CreatedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT TaxonTreeDefID FROM taxontreedef WHERE CreatedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function selectDistinctModifiedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $sql = "SELECT count(*) as druid_ct, ModifiedByAgentID FROM taxontreedef group by ModifiedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctCreatedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, CreatedByAgentID FROM taxontreedef group by CreatedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
...
// can use Druid to regenerate the taxontreedef.php file to reflect changes
// in the underlying database without overwriting your custom views of the data.
// 
class huh_taxontreedefView implements viewer
{
   var $model = null;
   ...
   public function getDetailsView($includeRelated=true, $editLinkURL='') {
       ...
       if ($editLinkURL!='') { 
          ...
          if (!$nullpk) { $returnvalue .= "<li>huh_taxontreedef <a href='$editLinkURL'>Edit</a></li>\n";  } 
       }
       $returnvalue .= "<li>".huh_taxontreedef::TAXONTREEDEFID.": ".$model->getTaxonTreeDefID()."</li>\n";
       $returnvalue .= "<li>".huh_taxontreedef::TIMESTAMPCREATED.": ".$model->getTimestampCreated()."</li>\n";
       $returnvalue .= "<li>".huh_taxontreedef::TIMESTAMPMODIFIED.": ".$model->getTimestampModified()."</li>\n";
       $returnvalue .= "<li>".huh_taxontreedef::VERSION.": ".$model->getVersion()."</li>\n";
       $returnvalue .= "<li>".huh_taxontreedef::FULLNAMEDIRECTION.": ".$model->getFullNameDirection()."</li>\n";
       $returnvalue .= "<li>".huh_taxontreedef::NAME.": ".$model->getName()."</li>\n";
       $returnvalue .= "<li>".huh_taxontreedef::REMARKS.": ".$model->getRemarks()."</li>\n";
       $returnvalue .= "<li>".huh_taxontreedef::MODIFIEDBYAGENTID.": ".$model->getModifiedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_taxontreedef::CREATEDBYAGENTID.": ".$model->getCreatedByAgentID()."</li>\n";
       if ($includeRelated) { 
   ...
   public function getJSON() {
       $returnvalue = '{ ';
       $model = $this->model;
       $returnvalue .= '"'.huh_taxontreedef::TAXONTREEDEFID.': "'.$model->getTaxonTreeDefID().'",';
       $returnvalue .= '"'.huh_taxontreedef::TIMESTAMPCREATED.': "'.$model->getTimestampCreated().'",';
       $returnvalue .= '"'.huh_taxontreedef::TIMESTAMPMODIFIED.': "'.$model->getTimestampModified().'",';
       $returnvalue .= '"'.huh_taxontreedef::VERSION.': "'.$model->getVersion().'",';
       $returnvalue .= '"'.huh_taxontreedef::FULLNAMEDIRECTION.': "'.$model->getFullNameDirection().'",';
       $returnvalue .= '"'.huh_taxontreedef::NAME.': "'.$model->getName().'",';
       $returnvalue .= '"'.huh_taxontreedef::REMARKS.': "'.$model->getRemarks().'",';
       $returnvalue .= '"'.huh_taxontreedef::MODIFIEDBYAGENTID.': "'.$model->getModifiedByAgentID().'",';
       $returnvalue .= '"'.huh_taxontreedef::CREATEDBYAGENTID.': "'.$model->getCreatedByAgentID().'" }';
       $returnvalue .= '</ul>';
       return  $returnvalue;
   }
   ...
   public function getHeaderRow() {
       $returnvalue = '<tr>';
       $returnvalue .= "<th>".huh_taxontreedef::TAXONTREEDEFID."</th>\n";
       $returnvalue .= "<th>".huh_taxontreedef::TIMESTAMPCREATED."</th>\n";
       $returnvalue .= "<th>".huh_taxontreedef::TIMESTAMPMODIFIED."</th>\n";
       $returnvalue .= "<th>".huh_taxontreedef::VERSION."</th>\n";
       $returnvalue .= "<th>".huh_taxontreedef::FULLNAMEDIRECTION."</th>\n";
       $returnvalue .= "<th>".huh_taxontreedef::NAME."</th>\n";
       $returnvalue .= "<th>".huh_taxontreedef::REMARKS."</th>\n";
       $returnvalue .= "<th>".huh_taxontreedef::MODIFIEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_taxontreedef::CREATEDBYAGENTID."</th>\n";
       $returnvalue .= '</tr>';
       return  $returnvalue;
   }
  ...
  function save'.$id.'() {
     ...
     dojo.xhrGet(saveprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_taxontreedef">';
       $returnvalue .= "<div id='div_$formnane' >";
       if($addform) { 
          $returnvalue .= "Add a new TaxonTreeDefID"; 
       } else { 
         $returnvalue .= "<div><label for=".huh_taxontreedef::TAXONTREEDEFID.">TAXONTREEDEFID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_taxontreedef::TAXONTREEDEFID." id=".huh_taxontreedef::TAXONTREEDEFID." value='".$model->getTaxonTreeDefID()."'  style=' width:".huh_taxontreedef::TAXONTREEDEFID_SIZE ."em;  '  maxlength='".huh_taxontreedef::TAXONTREEDEFID_SIZE ."' ></div>\n";
       }  
       $returnvalue .= "<div><label for=".huh_taxontreedef::TIMESTAMPCREATED.">TIMESTAMPCREATED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_taxontreedef::TIMESTAMPCREATED." id=".huh_taxontreedef::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  style=' width:".huh_taxontreedef::TIMESTAMPCREATED_SIZE ."em;  '  maxlength='".huh_taxontreedef::TIMESTAMPCREATED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_taxontreedef::TIMESTAMPMODIFIED.">TIMESTAMPMODIFIED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_taxontreedef::TIMESTAMPMODIFIED." id=".huh_taxontreedef::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  style=' width:".huh_taxontreedef::TIMESTAMPMODIFIED_SIZE ."em;  '  maxlength='".huh_taxontreedef::TIMESTAMPMODIFIED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_taxontreedef::VERSION.">VERSION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_taxontreedef::VERSION." id=".huh_taxontreedef::VERSION." value='".$model->getVersion()."'  style=' width:".huh_taxontreedef::VERSION_SIZE ."em;  '  maxlength='".huh_taxontreedef::VERSION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_taxontreedef::FULLNAMEDIRECTION.">FULLNAMEDIRECTION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_taxontreedef::FULLNAMEDIRECTION." id=".huh_taxontreedef::FULLNAMEDIRECTION." value='".$model->getFullNameDirection()."'  style=' width:".huh_taxontreedef::FULLNAMEDIRECTION_SIZE ."em;  '  maxlength='".huh_taxontreedef::FULLNAMEDIRECTION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_taxontreedef::NAME.">NAME</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_taxontreedef::NAME." id=".huh_taxontreedef::NAME." >".$model->getName()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_taxontreedef::REMARKS.">REMARKS</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_taxontreedef::REMARKS." id=".huh_taxontreedef::REMARKS." >".$model->getRemarks()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_taxontreedef::MODIFIEDBYAGENTID.">MODIFIEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_taxontreedef::MODIFIEDBYAGENTID." id=".huh_taxontreedef::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  style=' width:".huh_taxontreedef::MODIFIEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_taxontreedef::MODIFIEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_taxontreedef::CREATEDBYAGENTID.">CREATEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_taxontreedef::CREATEDBYAGENTID." id=".huh_taxontreedef::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  style=' width:".huh_taxontreedef::CREATEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_taxontreedef::CREATEDBYAGENTID_SIZE ."' ></div>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
  ...
  function deleterecord'.$id.'() {
     ...
     dojo.xhrGet(deleteprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_table value="huh_taxontreedef">';
       $returnvalue .= '<input type=hidden name=TaxonTreeDefID id=druid_table value="'.$id.'">';
       $returnvalue .= '<ul>';
   ...
   public function getEditFormView($includeRelated=true) {
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_taxontreedef">';
       $returnvalue .= '<ul>';
       $returnvalue .= "<li>TAXONTREEDEFID<input type=text name=".huh_taxontreedef::TAXONTREEDEFID." id=".huh_taxontreedef::TAXONTREEDEFID." value='".$model->getTaxonTreeDefID()."'  size='".huh_taxontreedef::TAXONTREEDEFID_SIZE ."'  maxlength='".huh_taxontreedef::TAXONTREEDEFID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPCREATED<input type=text name=".huh_taxontreedef::TIMESTAMPCREATED." id=".huh_taxontreedef::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  size='".huh_taxontreedef::TIMESTAMPCREATED_SIZE ."'  maxlength='".huh_taxontreedef::TIMESTAMPCREATED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPMODIFIED<input type=text name=".huh_taxontreedef::TIMESTAMPMODIFIED." id=".huh_taxontreedef::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  size='".huh_taxontreedef::TIMESTAMPMODIFIED_SIZE ."'  maxlength='".huh_taxontreedef::TIMESTAMPMODIFIED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>VERSION<input type=text name=".huh_taxontreedef::VERSION." id=".huh_taxontreedef::VERSION." value='".$model->getVersion()."'  size='".huh_taxontreedef::VERSION_SIZE ."'  maxlength='".huh_taxontreedef::VERSION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>FULLNAMEDIRECTION<input type=text name=".huh_taxontreedef::FULLNAMEDIRECTION." id=".huh_taxontreedef::FULLNAMEDIRECTION." value='".$model->getFullNameDirection()."'  size='".huh_taxontreedef::FULLNAMEDIRECTION_SIZE ."'  maxlength='".huh_taxontreedef::FULLNAMEDIRECTION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>NAME<input type=text name=".huh_taxontreedef::NAME." id=".huh_taxontreedef::NAME." value='".$model->getName()."'  size='51'  maxlength='".huh_taxontreedef::NAME_SIZE ."' ></li>\n";
       $returnvalue .= "<li>REMARKS<input type=text name=".huh_taxontreedef::REMARKS." id=".huh_taxontreedef::REMARKS." value='".$model->getRemarks()."'  size='51'  maxlength='".huh_taxontreedef::REMARKS_SIZE ."' ></li>\n";
       $returnvalue .= "<li>MODIFIEDBYAGENTID<input type=text name=".huh_taxontreedef::MODIFIEDBYAGENTID." id=".huh_taxontreedef::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  size='".huh_taxontreedef::MODIFIEDBYAGENTID_SIZE ."'  maxlength='".huh_taxontreedef::MODIFIEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>CREATEDBYAGENTID<input type=text name=".huh_taxontreedef::CREATEDBYAGENTID." id=".huh_taxontreedef::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  size='".huh_taxontreedef::CREATEDBYAGENTID_SIZE ."'  maxlength='".huh_taxontreedef::CREATEDBYAGENTID_SIZE ."' ></li>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
