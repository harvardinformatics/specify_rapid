<?php
//==============================================================================
//===   workbenchtemplate.php                         
//===   Autogenerated by Druid from MySQL db Build:6
//==============================================================================

include_once("druid_interfaces.php");

class huh_workbenchtemplate implements  model , loadableModel, saveableModel, tableSchema 
{
...
*/
   ...
   private $WorkbenchTemplateID; // PK INTEGER 
   ...
   private $loaded;
   private $error;
   const FIELDLIST = ' WorkbenchTemplateID, TimestampCreated, TimestampModified, Version, Name, Remarks, SrcFilePath, SpecifyUserID, ModifiedByAgentID, CreatedByAgentID, ';
   const PKFIELDLIST = ' WorkbenchTemplateID, ';
   const NUMBER_OF_PRIMARY_KEYS = 1;
   private $primaryKeyArray = array( 1 => 'WorkbenchTemplateID'  ) ;
   private $allFieldsArray = array( 0 => 'WorkbenchTemplateID' , 1 => 'TimestampCreated' , 2 => 'TimestampModified' , 3 => 'Version' , 4 => 'Name' , 5 => 'Remarks' , 6 => 'SrcFilePath' , 7 => 'SpecifyUserID' , 8 => 'ModifiedByAgentID' , 9 => 'CreatedByAgentID'  ) ;
   private $selectDistinctFieldsArray = array( 7 => 'SpecifyUserID' , 8 => 'ModifiedByAgentID' , 9 => 'CreatedByAgentID'  ) ;

   //---------------------------------------------------------------------------

   // constructor 
   function huh_workbenchtemplate(){
...
/*WorkbenchTemplateID*/
   ...
   public function setWorkbenchTemplateID($WorkbenchTemplateID) {
       if (strlen(preg_replace('/[^0-9]/','',$WorkbenchTemplateID)) > huh_workbenchtemplate::WORKBENCHTEMPLATEID_SIZE) { 
...
/*TimestampCreated*/
   ...
   public function setTimestampCreated($TimestampCreated) {
       if (strlen($TimestampCreated) > huh_workbenchtemplate::TIMESTAMPCREATED_SIZE) { 
...
/*TimestampModified*/
   ...
   public function setTimestampModified($TimestampModified) {
       if (strlen($TimestampModified) > huh_workbenchtemplate::TIMESTAMPMODIFIED_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Version*/
   ...
   public function setVersion($Version) {
       if (strlen(preg_replace('/[^0-9]/','',$Version)) > huh_workbenchtemplate::VERSION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*Name*/
   ...
   public function setName($Name) {
       if (strlen($Name) > huh_workbenchtemplate::NAME_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Remarks*/
   ...
   public function setRemarks($Remarks) {
       if (strlen($Remarks) > huh_workbenchtemplate::REMARKS_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*SrcFilePath*/
   ...
   public function setSrcFilePath($SrcFilePath) {
       if (strlen($SrcFilePath) > huh_workbenchtemplate::SRCFILEPATH_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*SpecifyUserID*/
   ...
   public function setSpecifyUserID($SpecifyUserID) {
       if (strlen(preg_replace('/[^0-9]/','',$SpecifyUserID)) > huh_workbenchtemplate::SPECIFYUSERID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*ModifiedByAgentID*/
   ...
   public function setModifiedByAgentID($ModifiedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$ModifiedByAgentID)) > huh_workbenchtemplate::MODIFIEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*CreatedByAgentID*/
   ...
   public function setCreatedByAgentID($CreatedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$CreatedByAgentID)) > huh_workbenchtemplate::CREATEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
   ...
   public function PK() { // get value of primary key 
        $returnvalue = '';
        $returnvalue .= $this->getWorkbenchTemplateID();
        return $returnvalue;
   }
   public function PKArray() { // get name and value of primary key fields 
        $returnvalue = array();
        $returnvalue['WorkbenchTemplateID'] = $this->getWorkbenchTemplateID();
        return $returnvalue;
   }
  ...
  const C_CreatedByAgentIDMYSQLI_TYPE = 'i';
   ...
   public function load($pk) {
        ...
        try {
             if (is_array($pk)) { 
                 $this->setWorkbenchTemplateID($pk[WorkbenchTemplateID]);
             } else { ;
                 $this->setWorkbenchTemplateID($pk);
             };
        } 
        catch (Exception $e) { 
        ...
        if($this->WorkbenchTemplateID != NULL) {
           $sql = 'SELECT WorkbenchTemplateID, TimestampCreated, TimestampModified, Version, Name, Remarks, SrcFilePath, SpecifyUserID, ModifiedByAgentID, CreatedByAgentID FROM workbenchtemplate WHERE WorkbenchTemplateID = '.$this->WorkbenchTemplateID ;

           $preparesql = 'SELECT WorkbenchTemplateID, TimestampCreated, TimestampModified, Version, Name, Remarks, SrcFilePath, SpecifyUserID, ModifiedByAgentID, CreatedByAgentID FROM workbenchtemplate WHERE WorkbenchTemplateID = ? ';

           if ($statement = $connection->prepare($preparesql)) { 
              $statement->bind_param("i", $this->WorkbenchTemplateID);
              $statement->execute();
              $statement->bind_result($this->WorkbenchTemplateID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Name, $this->Remarks, $this->SrcFilePath, $this->SpecifyUserID, $this->ModifiedByAgentID, $this->CreatedByAgentID);
              $statement->fetch();
              $statement->close();
           }
   ...
   public function save() {
        ...
        if ($this->WorkbenchTemplateID!= NULL) {
            $sql  = 'UPDATE  workbenchtemplate SET ';
            $isInsert = false;
            ...
            $sql .= "  WHERE WorkbenchTemplateID = ? ";
        } else {
            $sql  = 'INSERT INTO workbenchtemplate ';
            $isInsert = true;
if ($this->PK==NULL) { throw new Exception('Can\'t insert record with null primary key for this table'); }
            $sql .= '( WorkbenchTemplateID ,  TimestampCreated ,  TimestampModified ,  Version ,  Name ,  Remarks ,  SrcFilePath ,  SpecifyUserID ,  ModifiedByAgentID ,  CreatedByAgentID ) VALUES (';
            $sql .=  "  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
        ...
        if ($statement = $connection->prepare($sql)) { 
           if ($this->WorkbenchTemplateID!= NULL ) {
              $statement->bind_param("ississsiiii", $this->WorkbenchTemplateID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->Name , $this->Remarks , $this->SrcFilePath , $this->SpecifyUserID , $this->ModifiedByAgentID , $this->CreatedByAgentID , $this->WorkbenchTemplateID );
           } else { 
              $statement->bind_param("ississsiii", $this->WorkbenchTemplateID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->Name , $this->Remarks , $this->SrcFilePath , $this->SpecifyUserID , $this->ModifiedByAgentID , $this->CreatedByAgentID );
           } 
           $statement->execute();
   ...
   public function delete() {
        ...
        if($this->WorkbenchTemplateID != NULL) {
           ...
           $preparedsql = 'SELECT  FROM workbenchtemplate WHERE  and WorkbenchTemplateID = ?  ' ;
        if ($statement = $connection->prepare($preparedsql)) { 
           $statement->bind_param("ississsiii", $this->WorkbenchTemplateID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Name, $this->Remarks, $this->SrcFilePath, $this->SpecifyUserID, $this->ModifiedByAgentID, $this->CreatedByAgentID);
           $statement->execute();
           $statement->store_result();
           if ($statement->num_rows()==1) {
                $sql = 'DELETE FROM workbenchtemplate WHERE  and WorkbenchTemplateID = ?  ';
                if ($stmt_delete = $connection->prepare($sql)) { 
                   $stmt_delete->bind_param("ississsiii", $this->WorkbenchTemplateID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Name, $this->Remarks, $this->SrcFilePath, $this->SpecifyUserID, $this->ModifiedByAgentID, $this->CreatedByAgentID);
   ...
   public function count() {
        ...
        global $connection;
        $returnvalue = false;
        $sql = 'SELECT count(*)  FROM workbenchtemplate';
   ...
   public function loadArrayKeyValueSearch($searchTermArray) {
       ...
       $sql = "SELECT WorkbenchTemplateID FROM workbenchtemplate $wherebit";
       if ($wherebit=='') { 
...
// TODO: *************** link to related tables 
  ...
  public function loadLinkedTo() { 
   ...
   public function keySelectAllConcatJSON($orderby='ASC') {
       ...
       $sql = "SELECT WorkbenchTemplateID, concat(IFNULL(TimestampCreated,'') || ' ' || IFNULL(TimestampModified,'') || ' ' || IFNULL(Version,'') || ' ' || IFNULL(Name,'') || ' ' || IFNULL(Remarks,'') || ' ' || IFNULL(SrcFilePath,'') || ' ' || IFNULL(SpecifyUserID,'') || ' ' || IFNULL(ModifiedByAgentID,'') || ' ' || IFNULL(CreatedByAgentID,'')) FROM workbenchtemplate order by SpecifyUserID, ModifiedByAgentID, CreatedByAgentID $order ";
       $comma = '';
       if ($result = $connection->query($sql)) { 
   ...
   public function keySelectDistinctJSON($field,$orderby='ASC') {
       ...
       if ($this->hasField($field)) { 
          ...
          if ($orderby=='ASC') { $order = 'ASC'; } else { $order = 'DESC'; } 
          $preparemysql = "SELECT DISTINCT $fieldesc FROM workbenchtemplate order by $fieldesc $order ";
          $comma = '';
   ...
   public function loadArrayBySpecifyUserID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT WorkbenchTemplateID FROM workbenchtemplate WHERE SpecifyUserID $operator '$searchTerm'";
        $preparedsql = "SELECT WorkbenchTemplateID FROM workbenchtemplate WHERE SpecifyUserID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
   ...
   public function loadArrayByModifiedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT WorkbenchTemplateID FROM workbenchtemplate WHERE ModifiedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT WorkbenchTemplateID FROM workbenchtemplate WHERE ModifiedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByCreatedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT WorkbenchTemplateID FROM workbenchtemplate WHERE CreatedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT WorkbenchTemplateID FROM workbenchtemplate WHERE CreatedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function selectDistinctSpecifyUserID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $sql = "SELECT count(*) as druid_ct, SpecifyUserID FROM workbenchtemplate group by SpecifyUserID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctModifiedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, ModifiedByAgentID FROM workbenchtemplate group by ModifiedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctCreatedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, CreatedByAgentID FROM workbenchtemplate group by CreatedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
...
// can use Druid to regenerate the workbenchtemplate.php file to reflect changes
// in the underlying database without overwriting your custom views of the data.
// 
class huh_workbenchtemplateView implements viewer
{
   var $model = null;
   ...
   public function getDetailsView($includeRelated=true, $editLinkURL='') {
       ...
       if ($editLinkURL!='') { 
          ...
          if (!$nullpk) { $returnvalue .= "<li>huh_workbenchtemplate <a href='$editLinkURL'>Edit</a></li>\n";  } 
       }
       $returnvalue .= "<li>".huh_workbenchtemplate::WORKBENCHTEMPLATEID.": ".$model->getWorkbenchTemplateID()."</li>\n";
       $returnvalue .= "<li>".huh_workbenchtemplate::TIMESTAMPCREATED.": ".$model->getTimestampCreated()."</li>\n";
       $returnvalue .= "<li>".huh_workbenchtemplate::TIMESTAMPMODIFIED.": ".$model->getTimestampModified()."</li>\n";
       $returnvalue .= "<li>".huh_workbenchtemplate::VERSION.": ".$model->getVersion()."</li>\n";
       $returnvalue .= "<li>".huh_workbenchtemplate::NAME.": ".$model->getName()."</li>\n";
       $returnvalue .= "<li>".huh_workbenchtemplate::REMARKS.": ".$model->getRemarks()."</li>\n";
       $returnvalue .= "<li>".huh_workbenchtemplate::SRCFILEPATH.": ".$model->getSrcFilePath()."</li>\n";
       $returnvalue .= "<li>".huh_workbenchtemplate::SPECIFYUSERID.": ".$model->getSpecifyUserID()."</li>\n";
       $returnvalue .= "<li>".huh_workbenchtemplate::MODIFIEDBYAGENTID.": ".$model->getModifiedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_workbenchtemplate::CREATEDBYAGENTID.": ".$model->getCreatedByAgentID()."</li>\n";
       if ($includeRelated) { 
   ...
   public function getJSON() {
       $returnvalue = '{ ';
       $model = $this->model;
       $returnvalue .= '"'.huh_workbenchtemplate::WORKBENCHTEMPLATEID.': "'.$model->getWorkbenchTemplateID().'",';
       $returnvalue .= '"'.huh_workbenchtemplate::TIMESTAMPCREATED.': "'.$model->getTimestampCreated().'",';
       $returnvalue .= '"'.huh_workbenchtemplate::TIMESTAMPMODIFIED.': "'.$model->getTimestampModified().'",';
       $returnvalue .= '"'.huh_workbenchtemplate::VERSION.': "'.$model->getVersion().'",';
       $returnvalue .= '"'.huh_workbenchtemplate::NAME.': "'.$model->getName().'",';
       $returnvalue .= '"'.huh_workbenchtemplate::REMARKS.': "'.$model->getRemarks().'",';
       $returnvalue .= '"'.huh_workbenchtemplate::SRCFILEPATH.': "'.$model->getSrcFilePath().'",';
       $returnvalue .= '"'.huh_workbenchtemplate::SPECIFYUSERID.': "'.$model->getSpecifyUserID().'",';
       $returnvalue .= '"'.huh_workbenchtemplate::MODIFIEDBYAGENTID.': "'.$model->getModifiedByAgentID().'",';
       $returnvalue .= '"'.huh_workbenchtemplate::CREATEDBYAGENTID.': "'.$model->getCreatedByAgentID().'" }';
       $returnvalue .= '</ul>';
       return  $returnvalue;
   }
   ...
   public function getHeaderRow() {
       $returnvalue = '<tr>';
       $returnvalue .= "<th>".huh_workbenchtemplate::WORKBENCHTEMPLATEID."</th>\n";
       $returnvalue .= "<th>".huh_workbenchtemplate::TIMESTAMPCREATED."</th>\n";
       $returnvalue .= "<th>".huh_workbenchtemplate::TIMESTAMPMODIFIED."</th>\n";
       $returnvalue .= "<th>".huh_workbenchtemplate::VERSION."</th>\n";
       $returnvalue .= "<th>".huh_workbenchtemplate::NAME."</th>\n";
       $returnvalue .= "<th>".huh_workbenchtemplate::REMARKS."</th>\n";
       $returnvalue .= "<th>".huh_workbenchtemplate::SRCFILEPATH."</th>\n";
       $returnvalue .= "<th>".huh_workbenchtemplate::SPECIFYUSERID."</th>\n";
       $returnvalue .= "<th>".huh_workbenchtemplate::MODIFIEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_workbenchtemplate::CREATEDBYAGENTID."</th>\n";
       $returnvalue .= '</tr>';
       return  $returnvalue;
   }
  ...
  function save'.$id.'() {
     ...
     dojo.xhrGet(saveprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_workbenchtemplate">';
       $returnvalue .= "<div id='div_$formnane' >";
       if($addform) { 
          $returnvalue .= "Add a new WorkbenchTemplateID"; 
       } else { 
         $returnvalue .= "<div><label for=".huh_workbenchtemplate::WORKBENCHTEMPLATEID.">WORKBENCHTEMPLATEID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_workbenchtemplate::WORKBENCHTEMPLATEID." id=".huh_workbenchtemplate::WORKBENCHTEMPLATEID." value='".$model->getWorkbenchTemplateID()."'  style=' width:".huh_workbenchtemplate::WORKBENCHTEMPLATEID_SIZE ."em;  '  maxlength='".huh_workbenchtemplate::WORKBENCHTEMPLATEID_SIZE ."' ></div>\n";
       }  
       $returnvalue .= "<div><label for=".huh_workbenchtemplate::TIMESTAMPCREATED.">TIMESTAMPCREATED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_workbenchtemplate::TIMESTAMPCREATED." id=".huh_workbenchtemplate::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  style=' width:".huh_workbenchtemplate::TIMESTAMPCREATED_SIZE ."em;  '  maxlength='".huh_workbenchtemplate::TIMESTAMPCREATED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_workbenchtemplate::TIMESTAMPMODIFIED.">TIMESTAMPMODIFIED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_workbenchtemplate::TIMESTAMPMODIFIED." id=".huh_workbenchtemplate::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  style=' width:".huh_workbenchtemplate::TIMESTAMPMODIFIED_SIZE ."em;  '  maxlength='".huh_workbenchtemplate::TIMESTAMPMODIFIED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_workbenchtemplate::VERSION.">VERSION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_workbenchtemplate::VERSION." id=".huh_workbenchtemplate::VERSION." value='".$model->getVersion()."'  style=' width:".huh_workbenchtemplate::VERSION_SIZE ."em;  '  maxlength='".huh_workbenchtemplate::VERSION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_workbenchtemplate::NAME.">NAME</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_workbenchtemplate::NAME." id=".huh_workbenchtemplate::NAME." >".$model->getName()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_workbenchtemplate::REMARKS.">REMARKS</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_workbenchtemplate::REMARKS." id=".huh_workbenchtemplate::REMARKS." >".$model->getRemarks()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_workbenchtemplate::SRCFILEPATH.">SRCFILEPATH</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_workbenchtemplate::SRCFILEPATH." id=".huh_workbenchtemplate::SRCFILEPATH." >".$model->getSrcFilePath()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_workbenchtemplate::SPECIFYUSERID.">SPECIFYUSERID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_workbenchtemplate::SPECIFYUSERID." id=".huh_workbenchtemplate::SPECIFYUSERID." value='".$model->getSpecifyUserID()."'  style=' width:".huh_workbenchtemplate::SPECIFYUSERID_SIZE ."em;  '  maxlength='".huh_workbenchtemplate::SPECIFYUSERID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_workbenchtemplate::MODIFIEDBYAGENTID.">MODIFIEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_workbenchtemplate::MODIFIEDBYAGENTID." id=".huh_workbenchtemplate::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  style=' width:".huh_workbenchtemplate::MODIFIEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_workbenchtemplate::MODIFIEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_workbenchtemplate::CREATEDBYAGENTID.">CREATEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_workbenchtemplate::CREATEDBYAGENTID." id=".huh_workbenchtemplate::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  style=' width:".huh_workbenchtemplate::CREATEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_workbenchtemplate::CREATEDBYAGENTID_SIZE ."' ></div>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
  ...
  function deleterecord'.$id.'() {
     ...
     dojo.xhrGet(deleteprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_table value="huh_workbenchtemplate">';
       $returnvalue .= '<input type=hidden name=WorkbenchTemplateID id=druid_table value="'.$id.'">';
       $returnvalue .= '<ul>';
   ...
   public function getEditFormView($includeRelated=true) {
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_workbenchtemplate">';
       $returnvalue .= '<ul>';
       $returnvalue .= "<li>WORKBENCHTEMPLATEID<input type=text name=".huh_workbenchtemplate::WORKBENCHTEMPLATEID." id=".huh_workbenchtemplate::WORKBENCHTEMPLATEID." value='".$model->getWorkbenchTemplateID()."'  size='".huh_workbenchtemplate::WORKBENCHTEMPLATEID_SIZE ."'  maxlength='".huh_workbenchtemplate::WORKBENCHTEMPLATEID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPCREATED<input type=text name=".huh_workbenchtemplate::TIMESTAMPCREATED." id=".huh_workbenchtemplate::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  size='".huh_workbenchtemplate::TIMESTAMPCREATED_SIZE ."'  maxlength='".huh_workbenchtemplate::TIMESTAMPCREATED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPMODIFIED<input type=text name=".huh_workbenchtemplate::TIMESTAMPMODIFIED." id=".huh_workbenchtemplate::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  size='".huh_workbenchtemplate::TIMESTAMPMODIFIED_SIZE ."'  maxlength='".huh_workbenchtemplate::TIMESTAMPMODIFIED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>VERSION<input type=text name=".huh_workbenchtemplate::VERSION." id=".huh_workbenchtemplate::VERSION." value='".$model->getVersion()."'  size='".huh_workbenchtemplate::VERSION_SIZE ."'  maxlength='".huh_workbenchtemplate::VERSION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>NAME<input type=text name=".huh_workbenchtemplate::NAME." id=".huh_workbenchtemplate::NAME." value='".$model->getName()."'  size='51'  maxlength='".huh_workbenchtemplate::NAME_SIZE ."' ></li>\n";
       $returnvalue .= "<li>REMARKS<input type=text name=".huh_workbenchtemplate::REMARKS." id=".huh_workbenchtemplate::REMARKS." value='".$model->getRemarks()."'  size='51'  maxlength='".huh_workbenchtemplate::REMARKS_SIZE ."' ></li>\n";
       $returnvalue .= "<li>SRCFILEPATH<input type=text name=".huh_workbenchtemplate::SRCFILEPATH." id=".huh_workbenchtemplate::SRCFILEPATH." value='".$model->getSrcFilePath()."'  size='51'  maxlength='".huh_workbenchtemplate::SRCFILEPATH_SIZE ."' ></li>\n";
       $returnvalue .= "<li>SPECIFYUSERID<input type=text name=".huh_workbenchtemplate::SPECIFYUSERID." id=".huh_workbenchtemplate::SPECIFYUSERID." value='".$model->getSpecifyUserID()."'  size='".huh_workbenchtemplate::SPECIFYUSERID_SIZE ."'  maxlength='".huh_workbenchtemplate::SPECIFYUSERID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>MODIFIEDBYAGENTID<input type=text name=".huh_workbenchtemplate::MODIFIEDBYAGENTID." id=".huh_workbenchtemplate::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  size='".huh_workbenchtemplate::MODIFIEDBYAGENTID_SIZE ."'  maxlength='".huh_workbenchtemplate::MODIFIEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>CREATEDBYAGENTID<input type=text name=".huh_workbenchtemplate::CREATEDBYAGENTID." id=".huh_workbenchtemplate::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  size='".huh_workbenchtemplate::CREATEDBYAGENTID_SIZE ."'  maxlength='".huh_workbenchtemplate::CREATEDBYAGENTID_SIZE ."' ></li>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
