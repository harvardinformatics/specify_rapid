<?php
//==============================================================================
//===   geographytreedef.php                         
//===   Autogenerated by Druid from MySQL db Build:6
//==============================================================================

include_once("druid_interfaces.php");

class huh_geographytreedef implements  model , loadableModel, saveableModel, tableSchema 
{
...
*/
   ...
   private $GeographyTreeDefID; // PK INTEGER 
   ...
   private $loaded;
   private $error;
   const FIELDLIST = ' GeographyTreeDefID, TimestampCreated, TimestampModified, Version, FullNameDirection, Name, Remarks, CreatedByAgentID, ModifiedByAgentID, ';
   const PKFIELDLIST = ' GeographyTreeDefID, ';
   const NUMBER_OF_PRIMARY_KEYS = 1;
   private $primaryKeyArray = array( 1 => 'GeographyTreeDefID'  ) ;
   private $allFieldsArray = array( 0 => 'GeographyTreeDefID' , 1 => 'TimestampCreated' , 2 => 'TimestampModified' , 3 => 'Version' , 4 => 'FullNameDirection' , 5 => 'Name' , 6 => 'Remarks' , 7 => 'CreatedByAgentID' , 8 => 'ModifiedByAgentID'  ) ;
   private $selectDistinctFieldsArray = array( 7 => 'CreatedByAgentID' , 8 => 'ModifiedByAgentID'  ) ;

   //---------------------------------------------------------------------------

   // constructor 
   function huh_geographytreedef(){
...
/*GeographyTreeDefID*/
   ...
   public function setGeographyTreeDefID($GeographyTreeDefID) {
       if (strlen(preg_replace('/[^0-9]/','',$GeographyTreeDefID)) > huh_geographytreedef::GEOGRAPHYTREEDEFID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
       $GeographyTreeDefID = trim($GeographyTreeDefID);
       if (!ctype_digit(strval($GeographyTreeDefID)) && trim(strval($GeographyTreeDefID))!='' ) {
...
/*TimestampCreated*/
   ...
   public function setTimestampCreated($TimestampCreated) {
       if (strlen($TimestampCreated) > huh_geographytreedef::TIMESTAMPCREATED_SIZE) { 
...
/*TimestampModified*/
   ...
   public function setTimestampModified($TimestampModified) {
       if (strlen($TimestampModified) > huh_geographytreedef::TIMESTAMPMODIFIED_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Version*/
   ...
   public function setVersion($Version) {
       if (strlen(preg_replace('/[^0-9]/','',$Version)) > huh_geographytreedef::VERSION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*FullNameDirection*/
   ...
   public function setFullNameDirection($FullNameDirection) {
       if (strlen(preg_replace('/[^0-9]/','',$FullNameDirection)) > huh_geographytreedef::FULLNAMEDIRECTION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*Name*/
   ...
   public function setName($Name) {
       if (strlen($Name) > huh_geographytreedef::NAME_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Remarks*/
   ...
   public function setRemarks($Remarks) {
       if (strlen($Remarks) > huh_geographytreedef::REMARKS_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*CreatedByAgentID*/
   ...
   public function setCreatedByAgentID($CreatedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$CreatedByAgentID)) > huh_geographytreedef::CREATEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*ModifiedByAgentID*/
   ...
   public function setModifiedByAgentID($ModifiedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$ModifiedByAgentID)) > huh_geographytreedef::MODIFIEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
   ...
   public function PK() { // get value of primary key 
        $returnvalue = '';
        $returnvalue .= $this->getGeographyTreeDefID();
        return $returnvalue;
   }
   public function PKArray() { // get name and value of primary key fields 
        $returnvalue = array();
        $returnvalue['GeographyTreeDefID'] = $this->getGeographyTreeDefID();
        return $returnvalue;
   }
  ...
  const C_ModifiedByAgentIDMYSQLI_TYPE = 'i';
   ...
   public function load($pk) {
        ...
        try {
             if (is_array($pk)) { 
                 $this->setGeographyTreeDefID($pk[GeographyTreeDefID]);
             } else { ;
                 $this->setGeographyTreeDefID($pk);
             };
        } 
        catch (Exception $e) { 
        ...
        if($this->GeographyTreeDefID != NULL) {
           $sql = 'SELECT GeographyTreeDefID, TimestampCreated, TimestampModified, Version, FullNameDirection, Name, Remarks, CreatedByAgentID, ModifiedByAgentID FROM geographytreedef WHERE GeographyTreeDefID = '.$this->GeographyTreeDefID ;

           $preparesql = 'SELECT GeographyTreeDefID, TimestampCreated, TimestampModified, Version, FullNameDirection, Name, Remarks, CreatedByAgentID, ModifiedByAgentID FROM geographytreedef WHERE GeographyTreeDefID = ? ';

           if ($statement = $connection->prepare($preparesql)) { 
              $statement->bind_param("i", $this->GeographyTreeDefID);
              $statement->execute();
              $statement->bind_result($this->GeographyTreeDefID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->FullNameDirection, $this->Name, $this->Remarks, $this->CreatedByAgentID, $this->ModifiedByAgentID);
              $statement->fetch();
              $statement->close();
           }
   ...
   public function save() {
        ...
        if ($this->GeographyTreeDefID!= NULL) {
            $sql  = 'UPDATE  geographytreedef SET ';
            $isInsert = false;
            ...
            $sql .= "  WHERE GeographyTreeDefID = ? ";
        } else {
            $sql  = 'INSERT INTO geographytreedef ';
            $isInsert = true;
if ($this->PK==NULL) { throw new Exception('Can\'t insert record with null primary key for this table'); }
            $sql .= '( GeographyTreeDefID ,  TimestampCreated ,  TimestampModified ,  Version ,  FullNameDirection ,  Name ,  Remarks ,  CreatedByAgentID ,  ModifiedByAgentID ) VALUES (';
            $sql .=  "  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
        ...
        if ($statement = $connection->prepare($sql)) { 
           if ($this->GeographyTreeDefID!= NULL ) {
              $statement->bind_param("issiissiii", $this->GeographyTreeDefID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->FullNameDirection , $this->Name , $this->Remarks , $this->CreatedByAgentID , $this->ModifiedByAgentID , $this->GeographyTreeDefID );
           } else { 
              $statement->bind_param("issiissii", $this->GeographyTreeDefID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->FullNameDirection , $this->Name , $this->Remarks , $this->CreatedByAgentID , $this->ModifiedByAgentID );
           } 
           $statement->execute();
   ...
   public function delete() {
        ...
        if($this->GeographyTreeDefID != NULL) {
           ...
           $preparedsql = 'SELECT  FROM geographytreedef WHERE  and GeographyTreeDefID = ?  ' ;
        if ($statement = $connection->prepare($preparedsql)) { 
           $statement->bind_param("issiissii", $this->GeographyTreeDefID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->FullNameDirection, $this->Name, $this->Remarks, $this->CreatedByAgentID, $this->ModifiedByAgentID);
           $statement->execute();
           $statement->store_result();
           if ($statement->num_rows()==1) {
                $sql = 'DELETE FROM geographytreedef WHERE  and GeographyTreeDefID = ?  ';
                if ($stmt_delete = $connection->prepare($sql)) { 
                   $stmt_delete->bind_param("issiissii", $this->GeographyTreeDefID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->FullNameDirection, $this->Name, $this->Remarks, $this->CreatedByAgentID, $this->ModifiedByAgentID);
   ...
   public function count() {
        ...
        global $connection;
        $returnvalue = false;
        $sql = 'SELECT count(*)  FROM geographytreedef';
   ...
   public function loadArrayKeyValueSearch($searchTermArray) {
       ...
       $sql = "SELECT GeographyTreeDefID FROM geographytreedef $wherebit";
       if ($wherebit=='') { 
...
// TODO: *************** link to related tables 
  ...
  public function loadLinkedTo() { 
   ...
   public function keySelectAllConcatJSON($orderby='ASC') {
       ...
       $sql = "SELECT GeographyTreeDefID, concat(IFNULL(TimestampCreated,'') || ' ' || IFNULL(TimestampModified,'') || ' ' || IFNULL(Version,'') || ' ' || IFNULL(FullNameDirection,'') || ' ' || IFNULL(Name,'') || ' ' || IFNULL(Remarks,'') || ' ' || IFNULL(CreatedByAgentID,'') || ' ' || IFNULL(ModifiedByAgentID,'')) FROM geographytreedef order by CreatedByAgentID, ModifiedByAgentID $order ";
       $comma = '';
       if ($result = $connection->query($sql)) { 
   ...
   public function keySelectDistinctJSON($field,$orderby='ASC') {
       ...
       if ($this->hasField($field)) { 
          ...
          if ($orderby=='ASC') { $order = 'ASC'; } else { $order = 'DESC'; } 
          $preparemysql = "SELECT DISTINCT $fieldesc FROM geographytreedef order by $fieldesc $order ";
          $comma = '';
   ...
   public function loadArrayByCreatedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT GeographyTreeDefID FROM geographytreedef WHERE CreatedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT GeographyTreeDefID FROM geographytreedef WHERE CreatedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
   ...
   public function loadArrayByModifiedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT GeographyTreeDefID FROM geographytreedef WHERE ModifiedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT GeographyTreeDefID FROM geographytreedef WHERE ModifiedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function selectDistinctCreatedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $sql = "SELECT count(*) as druid_ct, CreatedByAgentID FROM geographytreedef group by CreatedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctModifiedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, ModifiedByAgentID FROM geographytreedef group by ModifiedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
...
// can use Druid to regenerate the geographytreedef.php file to reflect changes
// in the underlying database without overwriting your custom views of the data.
// 
class huh_geographytreedefView implements viewer
{
   var $model = null;
   ...
   public function getDetailsView($includeRelated=true, $editLinkURL='') {
       ...
       if ($editLinkURL!='') { 
          ...
          if (!$nullpk) { $returnvalue .= "<li>huh_geographytreedef <a href='$editLinkURL'>Edit</a></li>\n";  } 
       }
       $returnvalue .= "<li>".huh_geographytreedef::GEOGRAPHYTREEDEFID.": ".$model->getGeographyTreeDefID()."</li>\n";
       $returnvalue .= "<li>".huh_geographytreedef::TIMESTAMPCREATED.": ".$model->getTimestampCreated()."</li>\n";
       $returnvalue .= "<li>".huh_geographytreedef::TIMESTAMPMODIFIED.": ".$model->getTimestampModified()."</li>\n";
       $returnvalue .= "<li>".huh_geographytreedef::VERSION.": ".$model->getVersion()."</li>\n";
       $returnvalue .= "<li>".huh_geographytreedef::FULLNAMEDIRECTION.": ".$model->getFullNameDirection()."</li>\n";
       $returnvalue .= "<li>".huh_geographytreedef::NAME.": ".$model->getName()."</li>\n";
       $returnvalue .= "<li>".huh_geographytreedef::REMARKS.": ".$model->getRemarks()."</li>\n";
       $returnvalue .= "<li>".huh_geographytreedef::CREATEDBYAGENTID.": ".$model->getCreatedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_geographytreedef::MODIFIEDBYAGENTID.": ".$model->getModifiedByAgentID()."</li>\n";
       if ($includeRelated) { 
   ...
   public function getJSON() {
       $returnvalue = '{ ';
       $model = $this->model;
       $returnvalue .= '"'.huh_geographytreedef::GEOGRAPHYTREEDEFID.': "'.$model->getGeographyTreeDefID().'",';
       $returnvalue .= '"'.huh_geographytreedef::TIMESTAMPCREATED.': "'.$model->getTimestampCreated().'",';
       $returnvalue .= '"'.huh_geographytreedef::TIMESTAMPMODIFIED.': "'.$model->getTimestampModified().'",';
       $returnvalue .= '"'.huh_geographytreedef::VERSION.': "'.$model->getVersion().'",';
       $returnvalue .= '"'.huh_geographytreedef::FULLNAMEDIRECTION.': "'.$model->getFullNameDirection().'",';
       $returnvalue .= '"'.huh_geographytreedef::NAME.': "'.$model->getName().'",';
       $returnvalue .= '"'.huh_geographytreedef::REMARKS.': "'.$model->getRemarks().'",';
       $returnvalue .= '"'.huh_geographytreedef::CREATEDBYAGENTID.': "'.$model->getCreatedByAgentID().'",';
       $returnvalue .= '"'.huh_geographytreedef::MODIFIEDBYAGENTID.': "'.$model->getModifiedByAgentID().'" }';
       $returnvalue .= '</ul>';
       return  $returnvalue;
   }
   ...
   public function getHeaderRow() {
       $returnvalue = '<tr>';
       $returnvalue .= "<th>".huh_geographytreedef::GEOGRAPHYTREEDEFID."</th>\n";
       $returnvalue .= "<th>".huh_geographytreedef::TIMESTAMPCREATED."</th>\n";
       $returnvalue .= "<th>".huh_geographytreedef::TIMESTAMPMODIFIED."</th>\n";
       $returnvalue .= "<th>".huh_geographytreedef::VERSION."</th>\n";
       $returnvalue .= "<th>".huh_geographytreedef::FULLNAMEDIRECTION."</th>\n";
       $returnvalue .= "<th>".huh_geographytreedef::NAME."</th>\n";
       $returnvalue .= "<th>".huh_geographytreedef::REMARKS."</th>\n";
       $returnvalue .= "<th>".huh_geographytreedef::CREATEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_geographytreedef::MODIFIEDBYAGENTID."</th>\n";
       $returnvalue .= '</tr>';
       return  $returnvalue;
   }
  ...
  function save'.$id.'() {
     ...
     dojo.xhrGet(saveprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_geographytreedef">';
       $returnvalue .= "<div id='div_$formnane' >";
       if($addform) { 
          $returnvalue .= "Add a new GeographyTreeDefID"; 
       } else { 
         $returnvalue .= "<div><label for=".huh_geographytreedef::GEOGRAPHYTREEDEFID.">GEOGRAPHYTREEDEFID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_geographytreedef::GEOGRAPHYTREEDEFID." id=".huh_geographytreedef::GEOGRAPHYTREEDEFID." value='".$model->getGeographyTreeDefID()."'  style=' width:".huh_geographytreedef::GEOGRAPHYTREEDEFID_SIZE ."em;  '  maxlength='".huh_geographytreedef::GEOGRAPHYTREEDEFID_SIZE ."' ></div>\n";
       }  
       $returnvalue .= "<div><label for=".huh_geographytreedef::TIMESTAMPCREATED.">TIMESTAMPCREATED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_geographytreedef::TIMESTAMPCREATED." id=".huh_geographytreedef::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  style=' width:".huh_geographytreedef::TIMESTAMPCREATED_SIZE ."em;  '  maxlength='".huh_geographytreedef::TIMESTAMPCREATED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_geographytreedef::TIMESTAMPMODIFIED.">TIMESTAMPMODIFIED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_geographytreedef::TIMESTAMPMODIFIED." id=".huh_geographytreedef::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  style=' width:".huh_geographytreedef::TIMESTAMPMODIFIED_SIZE ."em;  '  maxlength='".huh_geographytreedef::TIMESTAMPMODIFIED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_geographytreedef::VERSION.">VERSION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_geographytreedef::VERSION." id=".huh_geographytreedef::VERSION." value='".$model->getVersion()."'  style=' width:".huh_geographytreedef::VERSION_SIZE ."em;  '  maxlength='".huh_geographytreedef::VERSION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_geographytreedef::FULLNAMEDIRECTION.">FULLNAMEDIRECTION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_geographytreedef::FULLNAMEDIRECTION." id=".huh_geographytreedef::FULLNAMEDIRECTION." value='".$model->getFullNameDirection()."'  style=' width:".huh_geographytreedef::FULLNAMEDIRECTION_SIZE ."em;  '  maxlength='".huh_geographytreedef::FULLNAMEDIRECTION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_geographytreedef::NAME.">NAME</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_geographytreedef::NAME." id=".huh_geographytreedef::NAME." >".$model->getName()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_geographytreedef::REMARKS.">REMARKS</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_geographytreedef::REMARKS." id=".huh_geographytreedef::REMARKS." >".$model->getRemarks()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_geographytreedef::CREATEDBYAGENTID.">CREATEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_geographytreedef::CREATEDBYAGENTID." id=".huh_geographytreedef::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  style=' width:".huh_geographytreedef::CREATEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_geographytreedef::CREATEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_geographytreedef::MODIFIEDBYAGENTID.">MODIFIEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_geographytreedef::MODIFIEDBYAGENTID." id=".huh_geographytreedef::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  style=' width:".huh_geographytreedef::MODIFIEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_geographytreedef::MODIFIEDBYAGENTID_SIZE ."' ></div>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
  ...
  function deleterecord'.$id.'() {
     ...
     dojo.xhrGet(deleteprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_table value="huh_geographytreedef">';
       $returnvalue .= '<input type=hidden name=GeographyTreeDefID id=druid_table value="'.$id.'">';
       $returnvalue .= '<ul>';
   ...
   public function getEditFormView($includeRelated=true) {
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_geographytreedef">';
       $returnvalue .= '<ul>';
       $returnvalue .= "<li>GEOGRAPHYTREEDEFID<input type=text name=".huh_geographytreedef::GEOGRAPHYTREEDEFID." id=".huh_geographytreedef::GEOGRAPHYTREEDEFID." value='".$model->getGeographyTreeDefID()."'  size='".huh_geographytreedef::GEOGRAPHYTREEDEFID_SIZE ."'  maxlength='".huh_geographytreedef::GEOGRAPHYTREEDEFID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPCREATED<input type=text name=".huh_geographytreedef::TIMESTAMPCREATED." id=".huh_geographytreedef::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  size='".huh_geographytreedef::TIMESTAMPCREATED_SIZE ."'  maxlength='".huh_geographytreedef::TIMESTAMPCREATED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPMODIFIED<input type=text name=".huh_geographytreedef::TIMESTAMPMODIFIED." id=".huh_geographytreedef::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  size='".huh_geographytreedef::TIMESTAMPMODIFIED_SIZE ."'  maxlength='".huh_geographytreedef::TIMESTAMPMODIFIED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>VERSION<input type=text name=".huh_geographytreedef::VERSION." id=".huh_geographytreedef::VERSION." value='".$model->getVersion()."'  size='".huh_geographytreedef::VERSION_SIZE ."'  maxlength='".huh_geographytreedef::VERSION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>FULLNAMEDIRECTION<input type=text name=".huh_geographytreedef::FULLNAMEDIRECTION." id=".huh_geographytreedef::FULLNAMEDIRECTION." value='".$model->getFullNameDirection()."'  size='".huh_geographytreedef::FULLNAMEDIRECTION_SIZE ."'  maxlength='".huh_geographytreedef::FULLNAMEDIRECTION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>NAME<input type=text name=".huh_geographytreedef::NAME." id=".huh_geographytreedef::NAME." value='".$model->getName()."'  size='51'  maxlength='".huh_geographytreedef::NAME_SIZE ."' ></li>\n";
       $returnvalue .= "<li>REMARKS<input type=text name=".huh_geographytreedef::REMARKS." id=".huh_geographytreedef::REMARKS." value='".$model->getRemarks()."'  size='51'  maxlength='".huh_geographytreedef::REMARKS_SIZE ."' ></li>\n";
       $returnvalue .= "<li>CREATEDBYAGENTID<input type=text name=".huh_geographytreedef::CREATEDBYAGENTID." id=".huh_geographytreedef::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  size='".huh_geographytreedef::CREATEDBYAGENTID_SIZE ."'  maxlength='".huh_geographytreedef::CREATEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>MODIFIEDBYAGENTID<input type=text name=".huh_geographytreedef::MODIFIEDBYAGENTID." id=".huh_geographytreedef::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  size='".huh_geographytreedef::MODIFIEDBYAGENTID_SIZE ."'  maxlength='".huh_geographytreedef::MODIFIEDBYAGENTID_SIZE ."' ></li>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
