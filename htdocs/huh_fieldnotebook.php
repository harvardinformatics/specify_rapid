...
class huh_fieldnotebook implements  model , loadableModel, saveableModel, tableSchema 
{
...
*/
   ...
   private $FieldNotebookID; // PK INTEGER 
   ...
   private $loaded;
   private $error;
   const FIELDLIST = ' FieldNotebookID, TimestampCreated, TimestampModified, Version, Description, EndDate, Storage, Name, StartDate, CreatedByAgentID, CollectionID, ModifiedByAgentID, AgentID, DisciplineID, ';
   const PKFIELDLIST = ' FieldNotebookID, ';
   const NUMBER_OF_PRIMARY_KEYS = 1;
   private $primaryKeyArray = array( 1 => 'FieldNotebookID'  ) ;
   private $allFieldsArray = array( 0 => 'FieldNotebookID' , 1 => 'TimestampCreated' , 2 => 'TimestampModified' , 3 => 'Version' , 4 => 'Description' , 5 => 'EndDate' , 6 => 'Storage' , 7 => 'Name' , 8 => 'StartDate' , 9 => 'CreatedByAgentID' , 10 => 'CollectionID' , 11 => 'ModifiedByAgentID' , 12 => 'AgentID' , 13 => 'DisciplineID'  ) ;
   private $selectDistinctFieldsArray = array( 5 => 'EndDate' , 7 => 'Name' , 8 => 'StartDate' , 9 => 'CreatedByAgentID' , 10 => 'CollectionID' , 11 => 'ModifiedByAgentID' , 12 => 'AgentID' , 13 => 'DisciplineID'  ) ;

   //---------------------------------------------------------------------------

   // constructor 
   function huh_fieldnotebook(){
...
/*FieldNotebookID*/
   ...
   public function setFieldNotebookID($FieldNotebookID) {
       if (strlen(preg_replace('/[^0-9]/','',$FieldNotebookID)) > huh_fieldnotebook::FIELDNOTEBOOKID_SIZE) { 
...
/*TimestampCreated*/
   ...
   public function setTimestampCreated($TimestampCreated) {
       if (strlen($TimestampCreated) > huh_fieldnotebook::TIMESTAMPCREATED_SIZE) { 
...
/*TimestampModified*/
   ...
   public function setTimestampModified($TimestampModified) {
       if (strlen($TimestampModified) > huh_fieldnotebook::TIMESTAMPMODIFIED_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Version*/
   ...
   public function setVersion($Version) {
       if (strlen(preg_replace('/[^0-9]/','',$Version)) > huh_fieldnotebook::VERSION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*Description*/
   ...
   public function setDescription($Description) {
       if (strlen($Description) > huh_fieldnotebook::DESCRIPTION_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*EndDate*/
   ...
   public function setEndDate($EndDate) {
       if (strlen($EndDate) > huh_fieldnotebook::ENDDATE_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Storage*/
   ...
   public function setStorage($Storage) {
       if (strlen($Storage) > huh_fieldnotebook::STORAGE_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Name*/
   ...
   public function setName($Name) {
       if (strlen($Name) > huh_fieldnotebook::NAME_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*StartDate*/
   ...
   public function setStartDate($StartDate) {
       if (strlen($StartDate) > huh_fieldnotebook::STARTDATE_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*CreatedByAgentID*/
   ...
   public function setCreatedByAgentID($CreatedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$CreatedByAgentID)) > huh_fieldnotebook::CREATEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*CollectionID*/
   ...
   public function setCollectionID($CollectionID) {
       if (strlen(preg_replace('/[^0-9]/','',$CollectionID)) > huh_fieldnotebook::COLLECTIONID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*ModifiedByAgentID*/
   ...
   public function setModifiedByAgentID($ModifiedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$ModifiedByAgentID)) > huh_fieldnotebook::MODIFIEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*AgentID*/
   ...
   public function setAgentID($AgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$AgentID)) > huh_fieldnotebook::AGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*DisciplineID*/
   ...
   public function setDisciplineID($DisciplineID) {
       if (strlen(preg_replace('/[^0-9]/','',$DisciplineID)) > huh_fieldnotebook::DISCIPLINEID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
   ...
   public function PK() { // get value of primary key 
        $returnvalue = '';
        $returnvalue .= $this->getFieldNotebookID();
        return $returnvalue;
   }
   public function PKArray() { // get name and value of primary key fields 
        $returnvalue = array();
        $returnvalue['FieldNotebookID'] = $this->getFieldNotebookID();
        return $returnvalue;
   }
  ...
  const C_DisciplineIDMYSQLI_TYPE = 'i';
   ...
   public function load($pk) {
        ...
        try {
             if (is_array($pk)) { 
                 $this->setFieldNotebookID($pk[FieldNotebookID]);
             } else { ;
                 $this->setFieldNotebookID($pk);
             };
        } 
        catch (Exception $e) { 
        ...
        if($this->FieldNotebookID != NULL) {
           $sql = 'SELECT FieldNotebookID, TimestampCreated, TimestampModified, Version, Description, EndDate, Storage, Name, StartDate, CreatedByAgentID, CollectionID, ModifiedByAgentID, AgentID, DisciplineID FROM fieldnotebook WHERE FieldNotebookID = '.$this->FieldNotebookID ;

           $preparesql = 'SELECT FieldNotebookID, TimestampCreated, TimestampModified, Version, Description, EndDate, Storage, Name, StartDate, CreatedByAgentID, CollectionID, ModifiedByAgentID, AgentID, DisciplineID FROM fieldnotebook WHERE FieldNotebookID = ? ';

           if ($statement = $connection->prepare($preparesql)) { 
              $statement->bind_param("i", $this->FieldNotebookID);
              $statement->execute();
              $statement->bind_result($this->FieldNotebookID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Description, $this->EndDate, $this->Storage, $this->Name, $this->StartDate, $this->CreatedByAgentID, $this->CollectionID, $this->ModifiedByAgentID, $this->AgentID, $this->DisciplineID);
              $statement->fetch();
              $statement->close();
           }
   ...
   public function save() {
        ...
        if ($this->FieldNotebookID!= NULL) {
            ...
            $sql .= "  WHERE FieldNotebookID = ? ";
        } else {
            $sql  = 'INSERT INTO fieldnotebook ';
            $isInsert = true;
if ($this->PK==NULL) { throw new Exception('Can\'t insert record with null primary key for this table'); }
            $sql .= '( FieldNotebookID ,  TimestampCreated ,  TimestampModified ,  Version ,  Description ,  EndDate ,  Storage ,  Name ,  StartDate ,  CreatedByAgentID ,  CollectionID ,  ModifiedByAgentID ,  AgentID ,  DisciplineID ) VALUES (';
            $sql .=  "  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
        ...
        if ($statement = $connection->prepare($sql)) { 
           if ($this->FieldNotebookID!= NULL ) {
              $statement->bind_param("ississsssiiiiii", $this->FieldNotebookID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->Description , $this->EndDate , $this->Storage , $this->Name , $this->StartDate , $this->CreatedByAgentID , $this->CollectionID , $this->ModifiedByAgentID , $this->AgentID , $this->DisciplineID , $this->FieldNotebookID );
           } else { 
              $statement->bind_param("ississsssiiiii", $this->FieldNotebookID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->Description , $this->EndDate , $this->Storage , $this->Name , $this->StartDate , $this->CreatedByAgentID , $this->CollectionID , $this->ModifiedByAgentID , $this->AgentID , $this->DisciplineID );
           } 
           $statement->execute();
   ...
   public function delete() {
        ...
        if($this->FieldNotebookID != NULL) {
           ...
           $preparedsql = 'SELECT  FROM fieldnotebook WHERE  and FieldNotebookID = ?  ' ;
        if ($statement = $connection->prepare($preparedsql)) { 
           $statement->bind_param("ississsssiiiii", $this->FieldNotebookID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Description, $this->EndDate, $this->Storage, $this->Name, $this->StartDate, $this->CreatedByAgentID, $this->CollectionID, $this->ModifiedByAgentID, $this->AgentID, $this->DisciplineID);
           $statement->execute();
           $statement->store_result();
           if ($statement->num_rows()==1) {
                $sql = 'DELETE FROM fieldnotebook WHERE  and FieldNotebookID = ?  ';
                if ($stmt_delete = $connection->prepare($sql)) { 
                   $stmt_delete->bind_param("ississsssiiiii", $this->FieldNotebookID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Description, $this->EndDate, $this->Storage, $this->Name, $this->StartDate, $this->CreatedByAgentID, $this->CollectionID, $this->ModifiedByAgentID, $this->AgentID, $this->DisciplineID);
   ...
   public function count() {
        ...
        global $connection;
        $returnvalue = false;
        $sql = 'SELECT count(*)  FROM fieldnotebook';
   ...
   public function loadArrayKeyValueSearch($searchTermArray) {
       ...
       $sql = "SELECT FieldNotebookID FROM fieldnotebook $wherebit";
       if ($wherebit=='') { 
...
// TODO: *************** link to related tables 
  ...
  public function loadLinkedTo() { 
   ...
   public function keySelectAllConcatJSON($orderby='ASC') {
       ...
       $sql = "SELECT FieldNotebookID, concat(IFNULL(TimestampCreated,'') || ' ' || IFNULL(TimestampModified,'') || ' ' || IFNULL(Version,'') || ' ' || IFNULL(Description,'') || ' ' || IFNULL(EndDate,'') || ' ' || IFNULL(Storage,'') || ' ' || IFNULL(Name,'') || ' ' || IFNULL(StartDate,'') || ' ' || IFNULL(CreatedByAgentID,'') || ' ' || IFNULL(CollectionID,'') || ' ' || IFNULL(ModifiedByAgentID,'') || ' ' || IFNULL(AgentID,'') || ' ' || IFNULL(DisciplineID,'')) FROM fieldnotebook order by EndDate, Name, StartDate, CreatedByAgentID, CollectionID, ModifiedByAgentID, AgentID, DisciplineID $order ";
       $comma = '';
       if ($result = $connection->query($sql)) { 
   ...
   public function keySelectDistinctJSON($field,$orderby='ASC') {
       ...
       if ($this->hasField($field)) { 
          ...
          if ($orderby=='ASC') { $order = 'ASC'; } else { $order = 'DESC'; } 
          $preparemysql = "SELECT DISTINCT $fieldesc FROM fieldnotebook order by $fieldesc $order ";
          $comma = '';
   ...
   public function loadArrayByEndDate($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT FieldNotebookID FROM fieldnotebook WHERE EndDate $operator '$searchTerm'";
        $preparedsql = "SELECT FieldNotebookID FROM fieldnotebook WHERE EndDate $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
   ...
   public function loadArrayByName($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT FieldNotebookID FROM fieldnotebook WHERE Name $operator '$searchTerm'";
        $preparedsql = "SELECT FieldNotebookID FROM fieldnotebook WHERE Name $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByStartDate($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT FieldNotebookID FROM fieldnotebook WHERE StartDate $operator '$searchTerm'";
        $preparedsql = "SELECT FieldNotebookID FROM fieldnotebook WHERE StartDate $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByCreatedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT FieldNotebookID FROM fieldnotebook WHERE CreatedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT FieldNotebookID FROM fieldnotebook WHERE CreatedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByCollectionID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT FieldNotebookID FROM fieldnotebook WHERE CollectionID $operator '$searchTerm'";
        $preparedsql = "SELECT FieldNotebookID FROM fieldnotebook WHERE CollectionID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByModifiedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT FieldNotebookID FROM fieldnotebook WHERE ModifiedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT FieldNotebookID FROM fieldnotebook WHERE ModifiedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT FieldNotebookID FROM fieldnotebook WHERE AgentID $operator '$searchTerm'";
        $preparedsql = "SELECT FieldNotebookID FROM fieldnotebook WHERE AgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByDisciplineID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT FieldNotebookID FROM fieldnotebook WHERE DisciplineID $operator '$searchTerm'";
        $preparedsql = "SELECT FieldNotebookID FROM fieldnotebook WHERE DisciplineID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function selectDistinctEndDate($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $sql = "SELECT count(*) as druid_ct, EndDate FROM fieldnotebook group by EndDate order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctName($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' Name ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, Name FROM fieldnotebook group by Name order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctStartDate($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' StartDate ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, StartDate FROM fieldnotebook group by StartDate order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctCreatedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, CreatedByAgentID FROM fieldnotebook group by CreatedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctCollectionID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' CollectionID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, CollectionID FROM fieldnotebook group by CollectionID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctModifiedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, ModifiedByAgentID FROM fieldnotebook group by ModifiedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' AgentID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, AgentID FROM fieldnotebook group by AgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctDisciplineID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' DisciplineID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, DisciplineID FROM fieldnotebook group by DisciplineID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
...
// can use Druid to regenerate the fieldnotebook.php file to reflect changes
// in the underlying database without overwriting your custom views of the data.
// 
class huh_fieldnotebookView implements viewer
{
   var $model = null;
   ...
   public function getDetailsView($includeRelated=true, $editLinkURL='') {
       ...
       if ($editLinkURL!='') { 
          ...
          if (!$nullpk) { $returnvalue .= "<li>huh_fieldnotebook <a href='$editLinkURL'>Edit</a></li>\n";  } 
       }
       $returnvalue .= "<li>".huh_fieldnotebook::FIELDNOTEBOOKID.": ".$model->getFieldNotebookID()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::TIMESTAMPCREATED.": ".$model->getTimestampCreated()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::TIMESTAMPMODIFIED.": ".$model->getTimestampModified()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::VERSION.": ".$model->getVersion()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::DESCRIPTION.": ".$model->getDescription()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::ENDDATE.": ".$model->getEndDate()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::STORAGE.": ".$model->getStorage()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::NAME.": ".$model->getName()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::STARTDATE.": ".$model->getStartDate()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::CREATEDBYAGENTID.": ".$model->getCreatedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::COLLECTIONID.": ".$model->getCollectionID()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::MODIFIEDBYAGENTID.": ".$model->getModifiedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::AGENTID.": ".$model->getAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_fieldnotebook::DISCIPLINEID.": ".$model->getDisciplineID()."</li>\n";
       if ($includeRelated) { 
   ...
   public function getJSON() {
       $returnvalue = '{ ';
       $model = $this->model;
       $returnvalue .= '"'.huh_fieldnotebook::FIELDNOTEBOOKID.': "'.$model->getFieldNotebookID().'",';
       $returnvalue .= '"'.huh_fieldnotebook::TIMESTAMPCREATED.': "'.$model->getTimestampCreated().'",';
       $returnvalue .= '"'.huh_fieldnotebook::TIMESTAMPMODIFIED.': "'.$model->getTimestampModified().'",';
       $returnvalue .= '"'.huh_fieldnotebook::VERSION.': "'.$model->getVersion().'",';
       $returnvalue .= '"'.huh_fieldnotebook::DESCRIPTION.': "'.$model->getDescription().'",';
       $returnvalue .= '"'.huh_fieldnotebook::ENDDATE.': "'.$model->getEndDate().'",';
       $returnvalue .= '"'.huh_fieldnotebook::STORAGE.': "'.$model->getStorage().'",';
       $returnvalue .= '"'.huh_fieldnotebook::NAME.': "'.$model->getName().'",';
       $returnvalue .= '"'.huh_fieldnotebook::STARTDATE.': "'.$model->getStartDate().'",';
       $returnvalue .= '"'.huh_fieldnotebook::CREATEDBYAGENTID.': "'.$model->getCreatedByAgentID().'",';
       $returnvalue .= '"'.huh_fieldnotebook::COLLECTIONID.': "'.$model->getCollectionID().'",';
       $returnvalue .= '"'.huh_fieldnotebook::MODIFIEDBYAGENTID.': "'.$model->getModifiedByAgentID().'",';
       $returnvalue .= '"'.huh_fieldnotebook::AGENTID.': "'.$model->getAgentID().'",';
       $returnvalue .= '"'.huh_fieldnotebook::DISCIPLINEID.': "'.$model->getDisciplineID().'" }';
       $returnvalue .= '</ul>';
       return  $returnvalue;
   }
   ...
   public function getHeaderRow() {
       $returnvalue = '<tr>';
       $returnvalue .= "<th>".huh_fieldnotebook::FIELDNOTEBOOKID."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::TIMESTAMPCREATED."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::TIMESTAMPMODIFIED."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::VERSION."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::DESCRIPTION."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::ENDDATE."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::STORAGE."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::NAME."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::STARTDATE."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::CREATEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::COLLECTIONID."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::MODIFIEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::AGENTID."</th>\n";
       $returnvalue .= "<th>".huh_fieldnotebook::DISCIPLINEID."</th>\n";
       $returnvalue .= '</tr>';
       return  $returnvalue;
   }
  ...
  function save'.$id.'() {
     ...
     dojo.xhrGet(saveprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_fieldnotebook">';
       $returnvalue .= "<div id='div_$formnane' >";
       if($addform) { 
          $returnvalue .= "Add a new FieldNotebookID"; 
       } else { 
         $returnvalue .= "<div><label for=".huh_fieldnotebook::FIELDNOTEBOOKID.">FIELDNOTEBOOKID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_fieldnotebook::FIELDNOTEBOOKID." id=".huh_fieldnotebook::FIELDNOTEBOOKID." value='".$model->getFieldNotebookID()."'  style=' width:".huh_fieldnotebook::FIELDNOTEBOOKID_SIZE ."em;  '  maxlength='".huh_fieldnotebook::FIELDNOTEBOOKID_SIZE ."' ></div>\n";
       }  
       $returnvalue .= "<div><label for=".huh_fieldnotebook::TIMESTAMPCREATED.">TIMESTAMPCREATED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_fieldnotebook::TIMESTAMPCREATED." id=".huh_fieldnotebook::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  style=' width:".huh_fieldnotebook::TIMESTAMPCREATED_SIZE ."em;  '  maxlength='".huh_fieldnotebook::TIMESTAMPCREATED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::TIMESTAMPMODIFIED.">TIMESTAMPMODIFIED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_fieldnotebook::TIMESTAMPMODIFIED." id=".huh_fieldnotebook::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  style=' width:".huh_fieldnotebook::TIMESTAMPMODIFIED_SIZE ."em;  '  maxlength='".huh_fieldnotebook::TIMESTAMPMODIFIED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::VERSION.">VERSION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_fieldnotebook::VERSION." id=".huh_fieldnotebook::VERSION." value='".$model->getVersion()."'  style=' width:".huh_fieldnotebook::VERSION_SIZE ."em;  '  maxlength='".huh_fieldnotebook::VERSION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::DESCRIPTION.">DESCRIPTION</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_fieldnotebook::DESCRIPTION." id=".huh_fieldnotebook::DESCRIPTION." >".$model->getDescription()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::ENDDATE.">ENDDATE</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_fieldnotebook::ENDDATE." id=".huh_fieldnotebook::ENDDATE." value='".$model->getEndDate()."'  style=' width:".huh_fieldnotebook::ENDDATE_SIZE ."em;  '  maxlength='".huh_fieldnotebook::ENDDATE_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::STORAGE.">STORAGE</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_fieldnotebook::STORAGE." id=".huh_fieldnotebook::STORAGE." >".$model->getStorage()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::NAME.">NAME</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_fieldnotebook::NAME." id=".huh_fieldnotebook::NAME." value='".$model->getName()."'  style=' width:".huh_fieldnotebook::NAME_SIZE ."em;  '  maxlength='".huh_fieldnotebook::NAME_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::STARTDATE.">STARTDATE</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_fieldnotebook::STARTDATE." id=".huh_fieldnotebook::STARTDATE." value='".$model->getStartDate()."'  style=' width:".huh_fieldnotebook::STARTDATE_SIZE ."em;  '  maxlength='".huh_fieldnotebook::STARTDATE_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::CREATEDBYAGENTID.">CREATEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_fieldnotebook::CREATEDBYAGENTID." id=".huh_fieldnotebook::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  style=' width:".huh_fieldnotebook::CREATEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_fieldnotebook::CREATEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::COLLECTIONID.">COLLECTIONID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_fieldnotebook::COLLECTIONID." id=".huh_fieldnotebook::COLLECTIONID." value='".$model->getCollectionID()."'  style=' width:".huh_fieldnotebook::COLLECTIONID_SIZE ."em;  '  maxlength='".huh_fieldnotebook::COLLECTIONID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::MODIFIEDBYAGENTID.">MODIFIEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_fieldnotebook::MODIFIEDBYAGENTID." id=".huh_fieldnotebook::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  style=' width:".huh_fieldnotebook::MODIFIEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_fieldnotebook::MODIFIEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::AGENTID.">AGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_fieldnotebook::AGENTID." id=".huh_fieldnotebook::AGENTID." value='".$model->getAgentID()."'  style=' width:".huh_fieldnotebook::AGENTID_SIZE ."em;  '  maxlength='".huh_fieldnotebook::AGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_fieldnotebook::DISCIPLINEID.">DISCIPLINEID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_fieldnotebook::DISCIPLINEID." id=".huh_fieldnotebook::DISCIPLINEID." value='".$model->getDisciplineID()."'  style=' width:".huh_fieldnotebook::DISCIPLINEID_SIZE ."em;  '  maxlength='".huh_fieldnotebook::DISCIPLINEID_SIZE ."' ></div>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
  ...
  function deleterecord'.$id.'() {
     ...
     dojo.xhrGet(deleteprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_table value="huh_fieldnotebook">';
       $returnvalue .= '<input type=hidden name=FieldNotebookID id=druid_table value="'.$id.'">';
       $returnvalue .= '<ul>';
   ...
   public function getEditFormView($includeRelated=true) {
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_fieldnotebook">';
       $returnvalue .= '<ul>';
       $returnvalue .= "<li>FIELDNOTEBOOKID<input type=text name=".huh_fieldnotebook::FIELDNOTEBOOKID." id=".huh_fieldnotebook::FIELDNOTEBOOKID." value='".$model->getFieldNotebookID()."'  size='".huh_fieldnotebook::FIELDNOTEBOOKID_SIZE ."'  maxlength='".huh_fieldnotebook::FIELDNOTEBOOKID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPCREATED<input type=text name=".huh_fieldnotebook::TIMESTAMPCREATED." id=".huh_fieldnotebook::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  size='".huh_fieldnotebook::TIMESTAMPCREATED_SIZE ."'  maxlength='".huh_fieldnotebook::TIMESTAMPCREATED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPMODIFIED<input type=text name=".huh_fieldnotebook::TIMESTAMPMODIFIED." id=".huh_fieldnotebook::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  size='".huh_fieldnotebook::TIMESTAMPMODIFIED_SIZE ."'  maxlength='".huh_fieldnotebook::TIMESTAMPMODIFIED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>VERSION<input type=text name=".huh_fieldnotebook::VERSION." id=".huh_fieldnotebook::VERSION." value='".$model->getVersion()."'  size='".huh_fieldnotebook::VERSION_SIZE ."'  maxlength='".huh_fieldnotebook::VERSION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>DESCRIPTION<input type=text name=".huh_fieldnotebook::DESCRIPTION." id=".huh_fieldnotebook::DESCRIPTION." value='".$model->getDescription()."'  size='51'  maxlength='".huh_fieldnotebook::DESCRIPTION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>ENDDATE<input type=text name=".huh_fieldnotebook::ENDDATE." id=".huh_fieldnotebook::ENDDATE." value='".$model->getEndDate()."'  size='".huh_fieldnotebook::ENDDATE_SIZE ."'  maxlength='".huh_fieldnotebook::ENDDATE_SIZE ."' ></li>\n";
       $returnvalue .= "<li>STORAGE<input type=text name=".huh_fieldnotebook::STORAGE." id=".huh_fieldnotebook::STORAGE." value='".$model->getStorage()."'  size='51'  maxlength='".huh_fieldnotebook::STORAGE_SIZE ."' ></li>\n";
       $returnvalue .= "<li>NAME<input type=text name=".huh_fieldnotebook::NAME." id=".huh_fieldnotebook::NAME." value='".$model->getName()."'  size='".huh_fieldnotebook::NAME_SIZE ."'  maxlength='".huh_fieldnotebook::NAME_SIZE ."' ></li>\n";
       $returnvalue .= "<li>STARTDATE<input type=text name=".huh_fieldnotebook::STARTDATE." id=".huh_fieldnotebook::STARTDATE." value='".$model->getStartDate()."'  size='".huh_fieldnotebook::STARTDATE_SIZE ."'  maxlength='".huh_fieldnotebook::STARTDATE_SIZE ."' ></li>\n";
       $returnvalue .= "<li>CREATEDBYAGENTID<input type=text name=".huh_fieldnotebook::CREATEDBYAGENTID." id=".huh_fieldnotebook::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  size='".huh_fieldnotebook::CREATEDBYAGENTID_SIZE ."'  maxlength='".huh_fieldnotebook::CREATEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>COLLECTIONID<input type=text name=".huh_fieldnotebook::COLLECTIONID." id=".huh_fieldnotebook::COLLECTIONID." value='".$model->getCollectionID()."'  size='".huh_fieldnotebook::COLLECTIONID_SIZE ."'  maxlength='".huh_fieldnotebook::COLLECTIONID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>MODIFIEDBYAGENTID<input type=text name=".huh_fieldnotebook::MODIFIEDBYAGENTID." id=".huh_fieldnotebook::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  size='".huh_fieldnotebook::MODIFIEDBYAGENTID_SIZE ."'  maxlength='".huh_fieldnotebook::MODIFIEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>AGENTID<input type=text name=".huh_fieldnotebook::AGENTID." id=".huh_fieldnotebook::AGENTID." value='".$model->getAgentID()."'  size='".huh_fieldnotebook::AGENTID_SIZE ."'  maxlength='".huh_fieldnotebook::AGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>DISCIPLINEID<input type=text name=".huh_fieldnotebook::DISCIPLINEID." id=".huh_fieldnotebook::DISCIPLINEID." value='".$model->getDisciplineID()."'  size='".huh_fieldnotebook::DISCIPLINEID_SIZE ."'  maxlength='".huh_fieldnotebook::DISCIPLINEID_SIZE ."' ></li>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
