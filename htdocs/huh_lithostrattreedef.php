<?php
//==============================================================================
//===   lithostrattreedef.php                         
//===   Autogenerated by Druid from MySQL db Build:6
//==============================================================================

include_once("druid_interfaces.php");

class huh_lithostrattreedef implements  model , loadableModel, saveableModel, tableSchema 
{
...
*/
   ...
   private $LithoStratTreeDefID; // PK INTEGER 
   ...
   private $loaded;
   private $error;
   const FIELDLIST = ' LithoStratTreeDefID, TimestampCreated, TimestampModified, Version, FullNameDirection, Name, Remarks, CreatedByAgentID, ModifiedByAgentID, ';
   const PKFIELDLIST = ' LithoStratTreeDefID, ';
   const NUMBER_OF_PRIMARY_KEYS = 1;
   private $primaryKeyArray = array( 1 => 'LithoStratTreeDefID'  ) ;
   private $allFieldsArray = array( 0 => 'LithoStratTreeDefID' , 1 => 'TimestampCreated' , 2 => 'TimestampModified' , 3 => 'Version' , 4 => 'FullNameDirection' , 5 => 'Name' , 6 => 'Remarks' , 7 => 'CreatedByAgentID' , 8 => 'ModifiedByAgentID'  ) ;
   private $selectDistinctFieldsArray = array( 7 => 'CreatedByAgentID' , 8 => 'ModifiedByAgentID'  ) ;

   //---------------------------------------------------------------------------

   // constructor 
   function huh_lithostrattreedef(){
...
/*LithoStratTreeDefID*/
   ...
   public function setLithoStratTreeDefID($LithoStratTreeDefID) {
       if (strlen(preg_replace('/[^0-9]/','',$LithoStratTreeDefID)) > huh_lithostrattreedef::LITHOSTRATTREEDEFID_SIZE) { 
...
/*TimestampCreated*/
   ...
   public function setTimestampCreated($TimestampCreated) {
       if (strlen($TimestampCreated) > huh_lithostrattreedef::TIMESTAMPCREATED_SIZE) { 
...
/*TimestampModified*/
   ...
   public function setTimestampModified($TimestampModified) {
       if (strlen($TimestampModified) > huh_lithostrattreedef::TIMESTAMPMODIFIED_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Version*/
   ...
   public function setVersion($Version) {
       if (strlen(preg_replace('/[^0-9]/','',$Version)) > huh_lithostrattreedef::VERSION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*FullNameDirection*/
   ...
   public function setFullNameDirection($FullNameDirection) {
       if (strlen(preg_replace('/[^0-9]/','',$FullNameDirection)) > huh_lithostrattreedef::FULLNAMEDIRECTION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*Name*/
   ...
   public function setName($Name) {
       if (strlen($Name) > huh_lithostrattreedef::NAME_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Remarks*/
   ...
   public function setRemarks($Remarks) {
       if (strlen($Remarks) > huh_lithostrattreedef::REMARKS_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*CreatedByAgentID*/
   ...
   public function setCreatedByAgentID($CreatedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$CreatedByAgentID)) > huh_lithostrattreedef::CREATEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*ModifiedByAgentID*/
   ...
   public function setModifiedByAgentID($ModifiedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$ModifiedByAgentID)) > huh_lithostrattreedef::MODIFIEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
   ...
   public function PK() { // get value of primary key 
        $returnvalue = '';
        $returnvalue .= $this->getLithoStratTreeDefID();
        return $returnvalue;
   }
   public function PKArray() { // get name and value of primary key fields 
        $returnvalue = array();
        $returnvalue['LithoStratTreeDefID'] = $this->getLithoStratTreeDefID();
        return $returnvalue;
   }
  ...
  const C_ModifiedByAgentIDMYSQLI_TYPE = 'i';
   ...
   public function load($pk) {
        ...
        try {
             if (is_array($pk)) { 
                 $this->setLithoStratTreeDefID($pk[LithoStratTreeDefID]);
             } else { ;
                 $this->setLithoStratTreeDefID($pk);
             };
        } 
        catch (Exception $e) { 
        ...
        if($this->LithoStratTreeDefID != NULL) {
           $sql = 'SELECT LithoStratTreeDefID, TimestampCreated, TimestampModified, Version, FullNameDirection, Name, Remarks, CreatedByAgentID, ModifiedByAgentID FROM lithostrattreedef WHERE LithoStratTreeDefID = '.$this->LithoStratTreeDefID ;

           $preparesql = 'SELECT LithoStratTreeDefID, TimestampCreated, TimestampModified, Version, FullNameDirection, Name, Remarks, CreatedByAgentID, ModifiedByAgentID FROM lithostrattreedef WHERE LithoStratTreeDefID = ? ';

           if ($statement = $connection->prepare($preparesql)) { 
              $statement->bind_param("i", $this->LithoStratTreeDefID);
              $statement->execute();
              $statement->bind_result($this->LithoStratTreeDefID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->FullNameDirection, $this->Name, $this->Remarks, $this->CreatedByAgentID, $this->ModifiedByAgentID);
              $statement->fetch();
              $statement->close();
           }
   ...
   public function save() {
        ...
        if ($this->LithoStratTreeDefID!= NULL) {
            $sql  = 'UPDATE  lithostrattreedef SET ';
            $isInsert = false;
            ...
            $sql .= "  WHERE LithoStratTreeDefID = ? ";
        } else {
            $sql  = 'INSERT INTO lithostrattreedef ';
            $isInsert = true;
if ($this->PK==NULL) { throw new Exception('Can\'t insert record with null primary key for this table'); }
            $sql .= '( LithoStratTreeDefID ,  TimestampCreated ,  TimestampModified ,  Version ,  FullNameDirection ,  Name ,  Remarks ,  CreatedByAgentID ,  ModifiedByAgentID ) VALUES (';
            $sql .=  "  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
        ...
        if ($statement = $connection->prepare($sql)) { 
           if ($this->LithoStratTreeDefID!= NULL ) {
              $statement->bind_param("issiissiii", $this->LithoStratTreeDefID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->FullNameDirection , $this->Name , $this->Remarks , $this->CreatedByAgentID , $this->ModifiedByAgentID , $this->LithoStratTreeDefID );
           } else { 
              $statement->bind_param("issiissii", $this->LithoStratTreeDefID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->FullNameDirection , $this->Name , $this->Remarks , $this->CreatedByAgentID , $this->ModifiedByAgentID );
           } 
           $statement->execute();
   ...
   public function delete() {
        ...
        if($this->LithoStratTreeDefID != NULL) {
           ...
           $preparedsql = 'SELECT  FROM lithostrattreedef WHERE  and LithoStratTreeDefID = ?  ' ;
        if ($statement = $connection->prepare($preparedsql)) { 
           $statement->bind_param("issiissii", $this->LithoStratTreeDefID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->FullNameDirection, $this->Name, $this->Remarks, $this->CreatedByAgentID, $this->ModifiedByAgentID);
           $statement->execute();
           $statement->store_result();
           if ($statement->num_rows()==1) {
                $sql = 'DELETE FROM lithostrattreedef WHERE  and LithoStratTreeDefID = ?  ';
                if ($stmt_delete = $connection->prepare($sql)) { 
                   $stmt_delete->bind_param("issiissii", $this->LithoStratTreeDefID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->FullNameDirection, $this->Name, $this->Remarks, $this->CreatedByAgentID, $this->ModifiedByAgentID);
   ...
   public function count() {
        ...
        global $connection;
        $returnvalue = false;
        $sql = 'SELECT count(*)  FROM lithostrattreedef';
   ...
   public function loadArrayKeyValueSearch($searchTermArray) {
       ...
       $sql = "SELECT LithoStratTreeDefID FROM lithostrattreedef $wherebit";
       if ($wherebit=='') { 
...
// TODO: *************** link to related tables 
  ...
  public function loadLinkedTo() { 
   ...
   public function keySelectAllConcatJSON($orderby='ASC') {
       ...
       $sql = "SELECT LithoStratTreeDefID, concat(IFNULL(TimestampCreated,'') || ' ' || IFNULL(TimestampModified,'') || ' ' || IFNULL(Version,'') || ' ' || IFNULL(FullNameDirection,'') || ' ' || IFNULL(Name,'') || ' ' || IFNULL(Remarks,'') || ' ' || IFNULL(CreatedByAgentID,'') || ' ' || IFNULL(ModifiedByAgentID,'')) FROM lithostrattreedef order by CreatedByAgentID, ModifiedByAgentID $order ";
       $comma = '';
       if ($result = $connection->query($sql)) { 
   ...
   public function keySelectDistinctJSON($field,$orderby='ASC') {
       ...
       if ($this->hasField($field)) { 
          ...
          if ($orderby=='ASC') { $order = 'ASC'; } else { $order = 'DESC'; } 
          $preparemysql = "SELECT DISTINCT $fieldesc FROM lithostrattreedef order by $fieldesc $order ";
          $comma = '';
   ...
   public function loadArrayByCreatedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT LithoStratTreeDefID FROM lithostrattreedef WHERE CreatedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT LithoStratTreeDefID FROM lithostrattreedef WHERE CreatedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
   ...
   public function loadArrayByModifiedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT LithoStratTreeDefID FROM lithostrattreedef WHERE ModifiedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT LithoStratTreeDefID FROM lithostrattreedef WHERE ModifiedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function selectDistinctCreatedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $sql = "SELECT count(*) as druid_ct, CreatedByAgentID FROM lithostrattreedef group by CreatedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctModifiedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, ModifiedByAgentID FROM lithostrattreedef group by ModifiedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
...
// can use Druid to regenerate the lithostrattreedef.php file to reflect changes
// in the underlying database without overwriting your custom views of the data.
// 
class huh_lithostrattreedefView implements viewer
{
   var $model = null;
   ...
   public function getDetailsView($includeRelated=true, $editLinkURL='') {
       ...
       if ($editLinkURL!='') { 
          ...
          if (!$nullpk) { $returnvalue .= "<li>huh_lithostrattreedef <a href='$editLinkURL'>Edit</a></li>\n";  } 
       }
       $returnvalue .= "<li>".huh_lithostrattreedef::LITHOSTRATTREEDEFID.": ".$model->getLithoStratTreeDefID()."</li>\n";
       $returnvalue .= "<li>".huh_lithostrattreedef::TIMESTAMPCREATED.": ".$model->getTimestampCreated()."</li>\n";
       $returnvalue .= "<li>".huh_lithostrattreedef::TIMESTAMPMODIFIED.": ".$model->getTimestampModified()."</li>\n";
       $returnvalue .= "<li>".huh_lithostrattreedef::VERSION.": ".$model->getVersion()."</li>\n";
       $returnvalue .= "<li>".huh_lithostrattreedef::FULLNAMEDIRECTION.": ".$model->getFullNameDirection()."</li>\n";
       $returnvalue .= "<li>".huh_lithostrattreedef::NAME.": ".$model->getName()."</li>\n";
       $returnvalue .= "<li>".huh_lithostrattreedef::REMARKS.": ".$model->getRemarks()."</li>\n";
       $returnvalue .= "<li>".huh_lithostrattreedef::CREATEDBYAGENTID.": ".$model->getCreatedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_lithostrattreedef::MODIFIEDBYAGENTID.": ".$model->getModifiedByAgentID()."</li>\n";
       if ($includeRelated) { 
   ...
   public function getJSON() {
       $returnvalue = '{ ';
       $model = $this->model;
       $returnvalue .= '"'.huh_lithostrattreedef::LITHOSTRATTREEDEFID.': "'.$model->getLithoStratTreeDefID().'",';
       $returnvalue .= '"'.huh_lithostrattreedef::TIMESTAMPCREATED.': "'.$model->getTimestampCreated().'",';
       $returnvalue .= '"'.huh_lithostrattreedef::TIMESTAMPMODIFIED.': "'.$model->getTimestampModified().'",';
       $returnvalue .= '"'.huh_lithostrattreedef::VERSION.': "'.$model->getVersion().'",';
       $returnvalue .= '"'.huh_lithostrattreedef::FULLNAMEDIRECTION.': "'.$model->getFullNameDirection().'",';
       $returnvalue .= '"'.huh_lithostrattreedef::NAME.': "'.$model->getName().'",';
       $returnvalue .= '"'.huh_lithostrattreedef::REMARKS.': "'.$model->getRemarks().'",';
       $returnvalue .= '"'.huh_lithostrattreedef::CREATEDBYAGENTID.': "'.$model->getCreatedByAgentID().'",';
       $returnvalue .= '"'.huh_lithostrattreedef::MODIFIEDBYAGENTID.': "'.$model->getModifiedByAgentID().'" }';
       $returnvalue .= '</ul>';
       return  $returnvalue;
   }
   ...
   public function getHeaderRow() {
       $returnvalue = '<tr>';
       $returnvalue .= "<th>".huh_lithostrattreedef::LITHOSTRATTREEDEFID."</th>\n";
       $returnvalue .= "<th>".huh_lithostrattreedef::TIMESTAMPCREATED."</th>\n";
       $returnvalue .= "<th>".huh_lithostrattreedef::TIMESTAMPMODIFIED."</th>\n";
       $returnvalue .= "<th>".huh_lithostrattreedef::VERSION."</th>\n";
       $returnvalue .= "<th>".huh_lithostrattreedef::FULLNAMEDIRECTION."</th>\n";
       $returnvalue .= "<th>".huh_lithostrattreedef::NAME."</th>\n";
       $returnvalue .= "<th>".huh_lithostrattreedef::REMARKS."</th>\n";
       $returnvalue .= "<th>".huh_lithostrattreedef::CREATEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_lithostrattreedef::MODIFIEDBYAGENTID."</th>\n";
       $returnvalue .= '</tr>';
       return  $returnvalue;
   }
  ...
  function save'.$id.'() {
     ...
     dojo.xhrGet(saveprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_lithostrattreedef">';
       $returnvalue .= "<div id='div_$formnane' >";
       if($addform) { 
          $returnvalue .= "Add a new LithoStratTreeDefID"; 
       } else { 
         $returnvalue .= "<div><label for=".huh_lithostrattreedef::LITHOSTRATTREEDEFID.">LITHOSTRATTREEDEFID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_lithostrattreedef::LITHOSTRATTREEDEFID." id=".huh_lithostrattreedef::LITHOSTRATTREEDEFID." value='".$model->getLithoStratTreeDefID()."'  style=' width:".huh_lithostrattreedef::LITHOSTRATTREEDEFID_SIZE ."em;  '  maxlength='".huh_lithostrattreedef::LITHOSTRATTREEDEFID_SIZE ."' ></div>\n";
       }  
       $returnvalue .= "<div><label for=".huh_lithostrattreedef::TIMESTAMPCREATED.">TIMESTAMPCREATED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_lithostrattreedef::TIMESTAMPCREATED." id=".huh_lithostrattreedef::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  style=' width:".huh_lithostrattreedef::TIMESTAMPCREATED_SIZE ."em;  '  maxlength='".huh_lithostrattreedef::TIMESTAMPCREATED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_lithostrattreedef::TIMESTAMPMODIFIED.">TIMESTAMPMODIFIED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_lithostrattreedef::TIMESTAMPMODIFIED." id=".huh_lithostrattreedef::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  style=' width:".huh_lithostrattreedef::TIMESTAMPMODIFIED_SIZE ."em;  '  maxlength='".huh_lithostrattreedef::TIMESTAMPMODIFIED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_lithostrattreedef::VERSION.">VERSION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_lithostrattreedef::VERSION." id=".huh_lithostrattreedef::VERSION." value='".$model->getVersion()."'  style=' width:".huh_lithostrattreedef::VERSION_SIZE ."em;  '  maxlength='".huh_lithostrattreedef::VERSION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_lithostrattreedef::FULLNAMEDIRECTION.">FULLNAMEDIRECTION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_lithostrattreedef::FULLNAMEDIRECTION." id=".huh_lithostrattreedef::FULLNAMEDIRECTION." value='".$model->getFullNameDirection()."'  style=' width:".huh_lithostrattreedef::FULLNAMEDIRECTION_SIZE ."em;  '  maxlength='".huh_lithostrattreedef::FULLNAMEDIRECTION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_lithostrattreedef::NAME.">NAME</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_lithostrattreedef::NAME." id=".huh_lithostrattreedef::NAME." >".$model->getName()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_lithostrattreedef::REMARKS.">REMARKS</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_lithostrattreedef::REMARKS." id=".huh_lithostrattreedef::REMARKS." >".$model->getRemarks()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_lithostrattreedef::CREATEDBYAGENTID.">CREATEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_lithostrattreedef::CREATEDBYAGENTID." id=".huh_lithostrattreedef::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  style=' width:".huh_lithostrattreedef::CREATEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_lithostrattreedef::CREATEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_lithostrattreedef::MODIFIEDBYAGENTID.">MODIFIEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_lithostrattreedef::MODIFIEDBYAGENTID." id=".huh_lithostrattreedef::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  style=' width:".huh_lithostrattreedef::MODIFIEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_lithostrattreedef::MODIFIEDBYAGENTID_SIZE ."' ></div>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
  ...
  function deleterecord'.$id.'() {
     ...
     dojo.xhrGet(deleteprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_table value="huh_lithostrattreedef">';
       $returnvalue .= '<input type=hidden name=LithoStratTreeDefID id=druid_table value="'.$id.'">';
       $returnvalue .= '<ul>';
   ...
   public function getEditFormView($includeRelated=true) {
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_lithostrattreedef">';
       $returnvalue .= '<ul>';
       $returnvalue .= "<li>LITHOSTRATTREEDEFID<input type=text name=".huh_lithostrattreedef::LITHOSTRATTREEDEFID." id=".huh_lithostrattreedef::LITHOSTRATTREEDEFID." value='".$model->getLithoStratTreeDefID()."'  size='".huh_lithostrattreedef::LITHOSTRATTREEDEFID_SIZE ."'  maxlength='".huh_lithostrattreedef::LITHOSTRATTREEDEFID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPCREATED<input type=text name=".huh_lithostrattreedef::TIMESTAMPCREATED." id=".huh_lithostrattreedef::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  size='".huh_lithostrattreedef::TIMESTAMPCREATED_SIZE ."'  maxlength='".huh_lithostrattreedef::TIMESTAMPCREATED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPMODIFIED<input type=text name=".huh_lithostrattreedef::TIMESTAMPMODIFIED." id=".huh_lithostrattreedef::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  size='".huh_lithostrattreedef::TIMESTAMPMODIFIED_SIZE ."'  maxlength='".huh_lithostrattreedef::TIMESTAMPMODIFIED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>VERSION<input type=text name=".huh_lithostrattreedef::VERSION." id=".huh_lithostrattreedef::VERSION." value='".$model->getVersion()."'  size='".huh_lithostrattreedef::VERSION_SIZE ."'  maxlength='".huh_lithostrattreedef::VERSION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>FULLNAMEDIRECTION<input type=text name=".huh_lithostrattreedef::FULLNAMEDIRECTION." id=".huh_lithostrattreedef::FULLNAMEDIRECTION." value='".$model->getFullNameDirection()."'  size='".huh_lithostrattreedef::FULLNAMEDIRECTION_SIZE ."'  maxlength='".huh_lithostrattreedef::FULLNAMEDIRECTION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>NAME<input type=text name=".huh_lithostrattreedef::NAME." id=".huh_lithostrattreedef::NAME." value='".$model->getName()."'  size='51'  maxlength='".huh_lithostrattreedef::NAME_SIZE ."' ></li>\n";
       $returnvalue .= "<li>REMARKS<input type=text name=".huh_lithostrattreedef::REMARKS." id=".huh_lithostrattreedef::REMARKS." value='".$model->getRemarks()."'  size='51'  maxlength='".huh_lithostrattreedef::REMARKS_SIZE ."' ></li>\n";
       $returnvalue .= "<li>CREATEDBYAGENTID<input type=text name=".huh_lithostrattreedef::CREATEDBYAGENTID." id=".huh_lithostrattreedef::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  size='".huh_lithostrattreedef::CREATEDBYAGENTID_SIZE ."'  maxlength='".huh_lithostrattreedef::CREATEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>MODIFIEDBYAGENTID<input type=text name=".huh_lithostrattreedef::MODIFIEDBYAGENTID." id=".huh_lithostrattreedef::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  size='".huh_lithostrattreedef::MODIFIEDBYAGENTID_SIZE ."'  maxlength='".huh_lithostrattreedef::MODIFIEDBYAGENTID_SIZE ."' ></li>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
