   ...
   switch ($action) {
      case 'rapidaddprocessor':
         $feedback = "";
        	...
        	@$specificlocality = substr(preg_replace('/[^A-Za-z[:alpha:]\(\) \.\-]/','',$_GET['specificlocality']),0,huh_locality::LOCALITYNAME_SIZE);
        	...
        	@$specimenremarks= substr(preg_replace('/[^A-Za-z[:alpha:] \.\,\;]/','',$_GET['specimenremarks']),0,huh_collectionobject::REMARKS_SIZE);
