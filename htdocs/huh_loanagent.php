...
class huh_loanagent implements  model , loadableModel, saveableModel, tableSchema 
{
   // These constants hold the sizes the fields in this table in the database.
   const LOANAGENTID_SIZE     = 11; //INTEGER
...
/*  Customize these to limit each variable to narrowest possible set of known good values. 
  ...
  $LoanAgentID = substr(preg_replace('/[^0-9\-\[NULL\]]/','',$_GET['LoanAgentID']), 0, 11);
...
*/
   ...
   private $LoanAgentID; // PK INTEGER 
   ...
   private $loaded;
   private $error;
   const FIELDLIST = ' LoanAgentID, TimestampCreated, TimestampModified, Version, Remarks, Role, CreatedByAgentID, DisciplineID, AgentID, ModifiedByAgentID, LoanID, ';
   const PKFIELDLIST = ' LoanAgentID, ';
   const NUMBER_OF_PRIMARY_KEYS = 1;
   private $primaryKeyArray = array( 1 => 'LoanAgentID'  ) ;
   private $allFieldsArray = array( 0 => 'LoanAgentID' , 1 => 'TimestampCreated' , 2 => 'TimestampModified' , 3 => 'Version' , 4 => 'Remarks' , 5 => 'Role' , 6 => 'CreatedByAgentID' , 7 => 'DisciplineID' , 8 => 'AgentID' , 9 => 'ModifiedByAgentID' , 10 => 'LoanID'  ) ;
   private $selectDistinctFieldsArray = array( 5 => 'Role' , 6 => 'CreatedByAgentID' , 7 => 'DisciplineID' , 8 => 'AgentID' , 9 => 'ModifiedByAgentID' , 10 => 'LoanID'  ) ;

   //---------------------------------------------------------------------------

   // constructor 
   function huh_loanagent(){
   ...
   public function keyValueSet($fieldname,$value) {
       ...
       if ($this->hasField($fieldname)) { 
          try {
             if ($fieldname=='LoanAgentID') { $returnvalue = $this->setLoanAgentID($value); } 
   ...
   public function keyGet($fieldname) {
       ...
       if ($this->hasField($fieldname)) { 
          try {
             if ($fieldname=='LoanAgentID') { $returnvalue = $this->getLoanAgentID(); } 
...
/*LoanAgentID*/
   public function getLoanAgentID() {
       if ($this->LoanAgentID==null) { 
          return null;
       } else { ;
          return trim($this->l_stripslashes($this->LoanAgentID));
       }
   }
   public function setLoanAgentID($LoanAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$LoanAgentID)) > huh_loanagent::LOANAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
       $LoanAgentID = trim($LoanAgentID);
       if (!ctype_digit(strval($LoanAgentID)) && trim(strval($LoanAgentID))!='' ) {
             throw new Exception("Value must be an integer");
       }
       $this->LoanAgentID = $this->l_addslashes($LoanAgentID);
       $this->dirty = true;
   }
/*TimestampCreated*/
   ...
   public function setTimestampCreated($TimestampCreated) {
       if (strlen($TimestampCreated) > huh_loanagent::TIMESTAMPCREATED_SIZE) { 
...
/*TimestampModified*/
   ...
   public function setTimestampModified($TimestampModified) {
       if (strlen($TimestampModified) > huh_loanagent::TIMESTAMPMODIFIED_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Version*/
   ...
   public function setVersion($Version) {
       if (strlen(preg_replace('/[^0-9]/','',$Version)) > huh_loanagent::VERSION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*Remarks*/
   ...
   public function setRemarks($Remarks) {
       if (strlen($Remarks) > huh_loanagent::REMARKS_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Role*/
   ...
   public function setRole($Role) {
       if (strlen($Role) > huh_loanagent::ROLE_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*CreatedByAgentID*/
   ...
   public function setCreatedByAgentID($CreatedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$CreatedByAgentID)) > huh_loanagent::CREATEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*DisciplineID*/
   ...
   public function setDisciplineID($DisciplineID) {
       if (strlen(preg_replace('/[^0-9]/','',$DisciplineID)) > huh_loanagent::DISCIPLINEID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*AgentID*/
   ...
   public function setAgentID($AgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$AgentID)) > huh_loanagent::AGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*ModifiedByAgentID*/
   ...
   public function setModifiedByAgentID($ModifiedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$ModifiedByAgentID)) > huh_loanagent::MODIFIEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*LoanID*/
   ...
   public function setLoanID($LoanID) {
       if (strlen(preg_replace('/[^0-9]/','',$LoanID)) > huh_loanagent::LOANID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
       $LoanID = trim($LoanID);
   ...
   public function PK() { // get value of primary key 
        $returnvalue = '';
        $returnvalue .= $this->getLoanAgentID();
        return $returnvalue;
   }
   public function PKArray() { // get name and value of primary key fields 
        $returnvalue = array();
        $returnvalue['LoanAgentID'] = $this->getLoanAgentID();
        return $returnvalue;
   }
  ...
  const C_LoanAgentIDMYSQLI_TYPE = 'i';
  ...
  const C_LoanIDMYSQLI_TYPE = 'i';
   ...
   public function MySQLiFieldType($aFieldname) { 
      $retval = '';
      if ($aFieldname=='LoanAgentID') { $retval = self::C_LoanAgentIDMYSQLI_TYPE; }
   ...
   public function load($pk) {
        ...
        try {
             if (is_array($pk)) { 
                 $this->setLoanAgentID($pk[LoanAgentID]);
             } else { ;
                 $this->setLoanAgentID($pk);
             };
        } 
        catch (Exception $e) { 
        ...
        if($this->LoanAgentID != NULL) {
           $sql = 'SELECT LoanAgentID, TimestampCreated, TimestampModified, Version, Remarks, Role, CreatedByAgentID, DisciplineID, AgentID, ModifiedByAgentID, LoanID FROM loanagent WHERE LoanAgentID = '.$this->LoanAgentID ;

           $preparesql = 'SELECT LoanAgentID, TimestampCreated, TimestampModified, Version, Remarks, Role, CreatedByAgentID, DisciplineID, AgentID, ModifiedByAgentID, LoanID FROM loanagent WHERE LoanAgentID = ? ';

           if ($statement = $connection->prepare($preparesql)) { 
              $statement->bind_param("i", $this->LoanAgentID);
              $statement->execute();
              $statement->bind_result($this->LoanAgentID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Remarks, $this->Role, $this->CreatedByAgentID, $this->DisciplineID, $this->AgentID, $this->ModifiedByAgentID, $this->LoanID);
              $statement->fetch();
              $statement->close();
           }
   ...
   public function save() {
        ...
        if ($this->LoanAgentID!= NULL) {
            ...
            $sql .= "  WHERE LoanAgentID = ? ";
        } else {
            $sql  = 'INSERT INTO loanagent ';
            $isInsert = true;
if ($this->PK==NULL) { throw new Exception('Can\'t insert record with null primary key for this table'); }
            $sql .= '( LoanAgentID ,  TimestampCreated ,  TimestampModified ,  Version ,  Remarks ,  Role ,  CreatedByAgentID ,  DisciplineID ,  AgentID ,  ModifiedByAgentID ,  LoanID ) VALUES (';
            $sql .=  "  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
        ...
        if ($statement = $connection->prepare($sql)) { 
           if ($this->LoanAgentID!= NULL ) {
              $statement->bind_param("ississiiiiii", $this->LoanAgentID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->Remarks , $this->Role , $this->CreatedByAgentID , $this->DisciplineID , $this->AgentID , $this->ModifiedByAgentID , $this->LoanID , $this->LoanAgentID );
           } else { 
              $statement->bind_param("ississiiiii", $this->LoanAgentID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->Remarks , $this->Role , $this->CreatedByAgentID , $this->DisciplineID , $this->AgentID , $this->ModifiedByAgentID , $this->LoanID );
           } 
           $statement->execute();
   ...
   public function delete() {
        ...
        if($this->LoanAgentID != NULL) {
           ...
           $preparedsql = 'SELECT  FROM loanagent WHERE  and LoanAgentID = ?  ' ;
        if ($statement = $connection->prepare($preparedsql)) { 
           $statement->bind_param("ississiiiii", $this->LoanAgentID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Remarks, $this->Role, $this->CreatedByAgentID, $this->DisciplineID, $this->AgentID, $this->ModifiedByAgentID, $this->LoanID);
           $statement->execute();
           $statement->store_result();
           if ($statement->num_rows()==1) {
                $sql = 'DELETE FROM loanagent WHERE  and LoanAgentID = ?  ';
                if ($stmt_delete = $connection->prepare($sql)) { 
                   $stmt_delete->bind_param("ississiiiii", $this->LoanAgentID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Remarks, $this->Role, $this->CreatedByAgentID, $this->DisciplineID, $this->AgentID, $this->ModifiedByAgentID, $this->LoanID);
   ...
   public function count() {
        ...
        global $connection;
        $returnvalue = false;
        $sql = 'SELECT count(*)  FROM loanagent';
   ...
   public function loadArrayKeyValueSearch($searchTermArray) {
       ...
       $sql = "SELECT LoanAgentID FROM loanagent $wherebit";
       if ($wherebit=='') { 
...
// TODO: *************** link to related tables 
  ...
  public function loadLinkedTo() { 
   ...
   public function keySelectAllConcatJSON($orderby='ASC') {
       ...
       $sql = "SELECT LoanAgentID, concat(IFNULL(TimestampCreated,'') || ' ' || IFNULL(TimestampModified,'') || ' ' || IFNULL(Version,'') || ' ' || IFNULL(Remarks,'') || ' ' || IFNULL(Role,'') || ' ' || IFNULL(CreatedByAgentID,'') || ' ' || IFNULL(DisciplineID,'') || ' ' || IFNULL(AgentID,'') || ' ' || IFNULL(ModifiedByAgentID,'') || ' ' || IFNULL(LoanID,'')) FROM loanagent order by Role, CreatedByAgentID, DisciplineID, AgentID, ModifiedByAgentID, LoanID $order ";
       $comma = '';
       if ($result = $connection->query($sql)) { 
   ...
   public function keySelectDistinctJSON($field,$orderby='ASC') {
       ...
       if ($this->hasField($field)) { 
          ...
          if ($orderby=='ASC') { $order = 'ASC'; } else { $order = 'DESC'; } 
          $preparemysql = "SELECT DISTINCT $fieldesc FROM loanagent order by $fieldesc $order ";
          $comma = '';
   ...
   public function loadArrayByRole($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT LoanAgentID FROM loanagent WHERE Role $operator '$searchTerm'";
        $preparedsql = "SELECT LoanAgentID FROM loanagent WHERE Role $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
   ...
   public function loadArrayByCreatedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT LoanAgentID FROM loanagent WHERE CreatedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT LoanAgentID FROM loanagent WHERE CreatedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByDisciplineID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT LoanAgentID FROM loanagent WHERE DisciplineID $operator '$searchTerm'";
        $preparedsql = "SELECT LoanAgentID FROM loanagent WHERE DisciplineID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT LoanAgentID FROM loanagent WHERE AgentID $operator '$searchTerm'";
        $preparedsql = "SELECT LoanAgentID FROM loanagent WHERE AgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByModifiedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT LoanAgentID FROM loanagent WHERE ModifiedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT LoanAgentID FROM loanagent WHERE ModifiedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByLoanID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT LoanAgentID FROM loanagent WHERE LoanID $operator '$searchTerm'";
        $preparedsql = "SELECT LoanAgentID FROM loanagent WHERE LoanID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function selectDistinctRole($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $sql = "SELECT count(*) as druid_ct, Role FROM loanagent group by Role order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctCreatedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, CreatedByAgentID FROM loanagent group by CreatedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctDisciplineID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' DisciplineID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, DisciplineID FROM loanagent group by DisciplineID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' AgentID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, AgentID FROM loanagent group by AgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctModifiedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, ModifiedByAgentID FROM loanagent group by ModifiedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctLoanID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' LoanID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, LoanID FROM loanagent group by LoanID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
...
// can use Druid to regenerate the loanagent.php file to reflect changes
// in the underlying database without overwriting your custom views of the data.
// 
class huh_loanagentView implements viewer
{
   var $model = null;
   ...
   public function getDetailsView($includeRelated=true, $editLinkURL='') {
       ...
       if ($editLinkURL!='') { 
          ...
          if (!$nullpk) { $returnvalue .= "<li>huh_loanagent <a href='$editLinkURL'>Edit</a></li>\n";  } 
       }
       $returnvalue .= "<li>".huh_loanagent::LOANAGENTID.": ".$model->getLoanAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_loanagent::TIMESTAMPCREATED.": ".$model->getTimestampCreated()."</li>\n";
       $returnvalue .= "<li>".huh_loanagent::TIMESTAMPMODIFIED.": ".$model->getTimestampModified()."</li>\n";
       $returnvalue .= "<li>".huh_loanagent::VERSION.": ".$model->getVersion()."</li>\n";
       $returnvalue .= "<li>".huh_loanagent::REMARKS.": ".$model->getRemarks()."</li>\n";
       $returnvalue .= "<li>".huh_loanagent::ROLE.": ".$model->getRole()."</li>\n";
       $returnvalue .= "<li>".huh_loanagent::CREATEDBYAGENTID.": ".$model->getCreatedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_loanagent::DISCIPLINEID.": ".$model->getDisciplineID()."</li>\n";
       $returnvalue .= "<li>".huh_loanagent::AGENTID.": ".$model->getAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_loanagent::MODIFIEDBYAGENTID.": ".$model->getModifiedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_loanagent::LOANID.": ".$model->getLoanID()."</li>\n";
       if ($includeRelated) { 
   ...
   public function getJSON() {
       $returnvalue = '{ ';
       $model = $this->model;
       $returnvalue .= '"'.huh_loanagent::LOANAGENTID.': "'.$model->getLoanAgentID().'",';
       $returnvalue .= '"'.huh_loanagent::TIMESTAMPCREATED.': "'.$model->getTimestampCreated().'",';
       $returnvalue .= '"'.huh_loanagent::TIMESTAMPMODIFIED.': "'.$model->getTimestampModified().'",';
       $returnvalue .= '"'.huh_loanagent::VERSION.': "'.$model->getVersion().'",';
       $returnvalue .= '"'.huh_loanagent::REMARKS.': "'.$model->getRemarks().'",';
       $returnvalue .= '"'.huh_loanagent::ROLE.': "'.$model->getRole().'",';
       $returnvalue .= '"'.huh_loanagent::CREATEDBYAGENTID.': "'.$model->getCreatedByAgentID().'",';
       $returnvalue .= '"'.huh_loanagent::DISCIPLINEID.': "'.$model->getDisciplineID().'",';
       $returnvalue .= '"'.huh_loanagent::AGENTID.': "'.$model->getAgentID().'",';
       $returnvalue .= '"'.huh_loanagent::MODIFIEDBYAGENTID.': "'.$model->getModifiedByAgentID().'",';
       $returnvalue .= '"'.huh_loanagent::LOANID.': "'.$model->getLoanID().'" }';
       $returnvalue .= '</ul>';
       return  $returnvalue;
   }
   public function getTableRowView() {
       $returnvalue = '<tr>';
       $model = $this->model;
       $returnvalue .= "<td>".$model->getLoanAgentID()."</td>\n";
   ...
   public function getHeaderRow() {
       $returnvalue = '<tr>';
       $returnvalue .= "<th>".huh_loanagent::LOANAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_loanagent::TIMESTAMPCREATED."</th>\n";
       $returnvalue .= "<th>".huh_loanagent::TIMESTAMPMODIFIED."</th>\n";
       $returnvalue .= "<th>".huh_loanagent::VERSION."</th>\n";
       $returnvalue .= "<th>".huh_loanagent::REMARKS."</th>\n";
       $returnvalue .= "<th>".huh_loanagent::ROLE."</th>\n";
       $returnvalue .= "<th>".huh_loanagent::CREATEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_loanagent::DISCIPLINEID."</th>\n";
       $returnvalue .= "<th>".huh_loanagent::AGENTID."</th>\n";
       $returnvalue .= "<th>".huh_loanagent::MODIFIEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_loanagent::LOANID."</th>\n";
       $returnvalue .= '</tr>';
       return  $returnvalue;
   }
  ...
  function save'.$id.'() {
     ...
     dojo.xhrGet(saveprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_loanagent">';
       $returnvalue .= "<div id='div_$formnane' >";
       if($addform) { 
          $returnvalue .= "Add a new LoanAgentID"; 
       } else { 
         $returnvalue .= "<div><label for=".huh_loanagent::LOANAGENTID.">LOANAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_loanagent::LOANAGENTID." id=".huh_loanagent::LOANAGENTID." value='".$model->getLoanAgentID()."'  style=' width:".huh_loanagent::LOANAGENTID_SIZE ."em;  '  maxlength='".huh_loanagent::LOANAGENTID_SIZE ."' ></div>\n";
       }  
       $returnvalue .= "<div><label for=".huh_loanagent::TIMESTAMPCREATED.">TIMESTAMPCREATED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_loanagent::TIMESTAMPCREATED." id=".huh_loanagent::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  style=' width:".huh_loanagent::TIMESTAMPCREATED_SIZE ."em;  '  maxlength='".huh_loanagent::TIMESTAMPCREATED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_loanagent::TIMESTAMPMODIFIED.">TIMESTAMPMODIFIED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_loanagent::TIMESTAMPMODIFIED." id=".huh_loanagent::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  style=' width:".huh_loanagent::TIMESTAMPMODIFIED_SIZE ."em;  '  maxlength='".huh_loanagent::TIMESTAMPMODIFIED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_loanagent::VERSION.">VERSION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_loanagent::VERSION." id=".huh_loanagent::VERSION." value='".$model->getVersion()."'  style=' width:".huh_loanagent::VERSION_SIZE ."em;  '  maxlength='".huh_loanagent::VERSION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_loanagent::REMARKS.">REMARKS</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_loanagent::REMARKS." id=".huh_loanagent::REMARKS." >".$model->getRemarks()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_loanagent::ROLE.">ROLE</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_loanagent::ROLE." id=".huh_loanagent::ROLE." value='".$model->getRole()."'  style=' width:".huh_loanagent::ROLE_SIZE ."em;  '  maxlength='".huh_loanagent::ROLE_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_loanagent::CREATEDBYAGENTID.">CREATEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_loanagent::CREATEDBYAGENTID." id=".huh_loanagent::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  style=' width:".huh_loanagent::CREATEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_loanagent::CREATEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_loanagent::DISCIPLINEID.">DISCIPLINEID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_loanagent::DISCIPLINEID." id=".huh_loanagent::DISCIPLINEID." value='".$model->getDisciplineID()."'  style=' width:".huh_loanagent::DISCIPLINEID_SIZE ."em;  '  maxlength='".huh_loanagent::DISCIPLINEID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_loanagent::AGENTID.">AGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_loanagent::AGENTID." id=".huh_loanagent::AGENTID." value='".$model->getAgentID()."'  style=' width:".huh_loanagent::AGENTID_SIZE ."em;  '  maxlength='".huh_loanagent::AGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_loanagent::MODIFIEDBYAGENTID.">MODIFIEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_loanagent::MODIFIEDBYAGENTID." id=".huh_loanagent::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  style=' width:".huh_loanagent::MODIFIEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_loanagent::MODIFIEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_loanagent::LOANID.">LOANID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_loanagent::LOANID." id=".huh_loanagent::LOANID." value='".$model->getLoanID()."'  style=' width:".huh_loanagent::LOANID_SIZE ."em;  '  maxlength='".huh_loanagent::LOANID_SIZE ."' ></div>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
  ...
  function deleterecord'.$id.'() {
     ...
     dojo.xhrGet(deleteprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_table value="huh_loanagent">';
       $returnvalue .= '<input type=hidden name=LoanAgentID id=druid_table value="'.$id.'">';
       $returnvalue .= '<ul>';
   ...
   public function getEditFormView($includeRelated=true) {
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_loanagent">';
       $returnvalue .= '<ul>';
       $returnvalue .= "<li>LOANAGENTID<input type=text name=".huh_loanagent::LOANAGENTID." id=".huh_loanagent::LOANAGENTID." value='".$model->getLoanAgentID()."'  size='".huh_loanagent::LOANAGENTID_SIZE ."'  maxlength='".huh_loanagent::LOANAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPCREATED<input type=text name=".huh_loanagent::TIMESTAMPCREATED." id=".huh_loanagent::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  size='".huh_loanagent::TIMESTAMPCREATED_SIZE ."'  maxlength='".huh_loanagent::TIMESTAMPCREATED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPMODIFIED<input type=text name=".huh_loanagent::TIMESTAMPMODIFIED." id=".huh_loanagent::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  size='".huh_loanagent::TIMESTAMPMODIFIED_SIZE ."'  maxlength='".huh_loanagent::TIMESTAMPMODIFIED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>VERSION<input type=text name=".huh_loanagent::VERSION." id=".huh_loanagent::VERSION." value='".$model->getVersion()."'  size='".huh_loanagent::VERSION_SIZE ."'  maxlength='".huh_loanagent::VERSION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>REMARKS<input type=text name=".huh_loanagent::REMARKS." id=".huh_loanagent::REMARKS." value='".$model->getRemarks()."'  size='51'  maxlength='".huh_loanagent::REMARKS_SIZE ."' ></li>\n";
       $returnvalue .= "<li>ROLE<input type=text name=".huh_loanagent::ROLE." id=".huh_loanagent::ROLE." value='".$model->getRole()."'  size='".huh_loanagent::ROLE_SIZE ."'  maxlength='".huh_loanagent::ROLE_SIZE ."' ></li>\n";
       $returnvalue .= "<li>CREATEDBYAGENTID<input type=text name=".huh_loanagent::CREATEDBYAGENTID." id=".huh_loanagent::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  size='".huh_loanagent::CREATEDBYAGENTID_SIZE ."'  maxlength='".huh_loanagent::CREATEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>DISCIPLINEID<input type=text name=".huh_loanagent::DISCIPLINEID." id=".huh_loanagent::DISCIPLINEID." value='".$model->getDisciplineID()."'  size='".huh_loanagent::DISCIPLINEID_SIZE ."'  maxlength='".huh_loanagent::DISCIPLINEID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>AGENTID<input type=text name=".huh_loanagent::AGENTID." id=".huh_loanagent::AGENTID." value='".$model->getAgentID()."'  size='".huh_loanagent::AGENTID_SIZE ."'  maxlength='".huh_loanagent::AGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>MODIFIEDBYAGENTID<input type=text name=".huh_loanagent::MODIFIEDBYAGENTID." id=".huh_loanagent::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  size='".huh_loanagent::MODIFIEDBYAGENTID_SIZE ."'  maxlength='".huh_loanagent::MODIFIEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>LOANID<input type=text name=".huh_loanagent::LOANID." id=".huh_loanagent::LOANID." value='".$model->getLoanID()."'  size='".huh_loanagent::LOANID_SIZE ."'  maxlength='".huh_loanagent::LOANID_SIZE ."' ></li>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
