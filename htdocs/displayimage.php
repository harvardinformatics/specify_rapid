...
function image($barcode) {
   ...
   echo "<script>
     ...
     function doZoom(x,y,h,w,oh,ow) {
         ...
         startx = (xnew*scalefactor*magnification)-(window.innerWidth/2);  if (startx < 1) { startx = 1; }
         starty = (ynew*scalefactor*magnification)-(window.innerHeight/2);  if (starty < 1) { starty = 1; }
