  ...
  const C_ModifiedByAgentIDMYSQLI_TYPE = 'i';
   ...
   public function load($pk) {
        ...
        if($this->CollectionObjectID != NULL) {
           ...
           $preparesql = 'SELECT CollectionObjectID, TimestampCreated, TimestampModified, Version, CollectionMemberID, AltCatalogNumber, Availability, CatalogNumber, CatalogedDate, CatalogedDatePrecision, CatalogedDateVerbatim, CountAmt, Description, FieldNumber, GUID, InternalRemarks, Modifier, Name, Notifications, Number1, Number2, ProjectNumber, Remarks, Restrictions, Text1, Text2, Text3, Text4, TotalValue, Visibility, CONV(YesNo1,2,10) as YesNo1, YesNo2, YesNo3, YesNo4, YesNo5, YesNo6, VisibilitySetByID, CreatedByAgentID, CatalogerID, ContainerID, CollectingEventID, CollectionObjectAttributeID, PaleoContextID, CollectionID, FieldNotebookPageID, ModifiedByAgentID FROM collectionobject WHERE CollectionObjectID = ? ';
