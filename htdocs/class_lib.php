...
class huh_geography_custom extends huh_geography {
   ...
   public function selectDistinctParentGeographyJSON($childid,$parentrank) {
      global $connection;
      $returnvalue = '[';
      $preparemysql = "select distinct g1.geographyid, g1.name from geography g1, geography g2 where g2.geography = ? and g1.rankid = ? and g1.nodenumber < g2.nodenumber and g1.highestchildnodenumber > g2.nodenumber and g1.isaccepted = 1 order by g1.name asc ";
      $comma = '';
      if ($stmt = $connection->prepare($preparemysql)) {
