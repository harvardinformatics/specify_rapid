...
<script type="dojo/method" >
   ...
   function getUserHtml($caller="index.php") {
      ...
      if ($this->authenticated===true) {
         ...
         if ($caller=="rapid.php") { $returnvalue .= ' <a href="rapid.php?display=mainform&defaultcountry=&defaultprimary=&cleardefaultgeography=1&defaultherbarium=&defaultprepmethod=Pressed&defaultformat=Sheet&defaultproject=">SoRo</a>&nbsp;'; } 
