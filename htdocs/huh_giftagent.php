...
class huh_giftagent implements  model , loadableModel, saveableModel, tableSchema 
{
   // These constants hold the sizes the fields in this table in the database.
   const GIFTAGENTID_SIZE     = 11; //INTEGER
...
/*  Customize these to limit each variable to narrowest possible set of known good values. 
  ...
  $GiftAgentID = substr(preg_replace('/[^0-9\-\[NULL\]]/','',$_GET['GiftAgentID']), 0, 11);
...
*/
   ...
   private $GiftAgentID; // PK INTEGER 
   ...
   private $loaded;
   private $error;
   const FIELDLIST = ' GiftAgentID, TimestampCreated, TimestampModified, Version, Remarks, Role, ModifiedByAgentID, AgentID, DisciplineID, CreatedByAgentID, GiftID, ';
   const PKFIELDLIST = ' GiftAgentID, ';
   const NUMBER_OF_PRIMARY_KEYS = 1;
   private $primaryKeyArray = array( 1 => 'GiftAgentID'  ) ;
   private $allFieldsArray = array( 0 => 'GiftAgentID' , 1 => 'TimestampCreated' , 2 => 'TimestampModified' , 3 => 'Version' , 4 => 'Remarks' , 5 => 'Role' , 6 => 'ModifiedByAgentID' , 7 => 'AgentID' , 8 => 'DisciplineID' , 9 => 'CreatedByAgentID' , 10 => 'GiftID'  ) ;
   private $selectDistinctFieldsArray = array( 5 => 'Role' , 6 => 'ModifiedByAgentID' , 7 => 'AgentID' , 8 => 'DisciplineID' , 9 => 'CreatedByAgentID' , 10 => 'GiftID'  ) ;

   //---------------------------------------------------------------------------

   // constructor 
   function huh_giftagent(){
       $this->GiftAgentID = NULL;
   ...
   public function keyValueSet($fieldname,$value) {
       ...
       if ($this->hasField($fieldname)) { 
          try {
             if ($fieldname=='GiftAgentID') { $returnvalue = $this->setGiftAgentID($value); } 
   ...
   public function keyGet($fieldname) {
       ...
       if ($this->hasField($fieldname)) { 
          try {
             if ($fieldname=='GiftAgentID') { $returnvalue = $this->getGiftAgentID(); } 
...
/*GiftAgentID*/
   public function getGiftAgentID() {
       if ($this->GiftAgentID==null) { 
          return null;
       } else { ;
          return trim($this->l_stripslashes($this->GiftAgentID));
       }
   }
   public function setGiftAgentID($GiftAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$GiftAgentID)) > huh_giftagent::GIFTAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
       $GiftAgentID = trim($GiftAgentID);
       if (!ctype_digit(strval($GiftAgentID)) && trim(strval($GiftAgentID))!='' ) {
             throw new Exception("Value must be an integer");
       }
       $this->GiftAgentID = $this->l_addslashes($GiftAgentID);
       $this->dirty = true;
   }
/*TimestampCreated*/
   ...
   public function setTimestampCreated($TimestampCreated) {
       if (strlen($TimestampCreated) > huh_giftagent::TIMESTAMPCREATED_SIZE) { 
...
/*TimestampModified*/
   ...
   public function setTimestampModified($TimestampModified) {
       if (strlen($TimestampModified) > huh_giftagent::TIMESTAMPMODIFIED_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Version*/
   ...
   public function setVersion($Version) {
       if (strlen(preg_replace('/[^0-9]/','',$Version)) > huh_giftagent::VERSION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*Remarks*/
   ...
   public function setRemarks($Remarks) {
       if (strlen($Remarks) > huh_giftagent::REMARKS_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Role*/
   ...
   public function setRole($Role) {
       if (strlen($Role) > huh_giftagent::ROLE_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*ModifiedByAgentID*/
   ...
   public function setModifiedByAgentID($ModifiedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$ModifiedByAgentID)) > huh_giftagent::MODIFIEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*AgentID*/
   ...
   public function setAgentID($AgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$AgentID)) > huh_giftagent::AGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*DisciplineID*/
   ...
   public function setDisciplineID($DisciplineID) {
       if (strlen(preg_replace('/[^0-9]/','',$DisciplineID)) > huh_giftagent::DISCIPLINEID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*CreatedByAgentID*/
   ...
   public function setCreatedByAgentID($CreatedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$CreatedByAgentID)) > huh_giftagent::CREATEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*GiftID*/
   ...
   public function setGiftID($GiftID) {
       if (strlen(preg_replace('/[^0-9]/','',$GiftID)) > huh_giftagent::GIFTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
       $GiftID = trim($GiftID);
       if (!ctype_digit(strval($GiftID))) {
             throw new Exception("Value must be an integer");
       }
   ...
   public function PK() { // get value of primary key 
        $returnvalue = '';
        $returnvalue .= $this->getGiftAgentID();
        return $returnvalue;
   }
   public function PKArray() { // get name and value of primary key fields 
        $returnvalue = array();
        $returnvalue['GiftAgentID'] = $this->getGiftAgentID();
        return $returnvalue;
   }
  ...
  const C_GiftAgentIDMYSQLI_TYPE = 'i';
  ...
  const C_GiftIDMYSQLI_TYPE = 'i';
   ...
   public function MySQLiFieldType($aFieldname) { 
      $retval = '';
      if ($aFieldname=='GiftAgentID') { $retval = self::C_GiftAgentIDMYSQLI_TYPE; }
   ...
   public function load($pk) {
        ...
        try {
             if (is_array($pk)) { 
                 $this->setGiftAgentID($pk[GiftAgentID]);
             } else { ;
                 $this->setGiftAgentID($pk);
             };
        } 
        catch (Exception $e) { 
        ...
        if($this->GiftAgentID != NULL) {
           $sql = 'SELECT GiftAgentID, TimestampCreated, TimestampModified, Version, Remarks, Role, ModifiedByAgentID, AgentID, DisciplineID, CreatedByAgentID, GiftID FROM giftagent WHERE GiftAgentID = '.$this->GiftAgentID ;

           $preparesql = 'SELECT GiftAgentID, TimestampCreated, TimestampModified, Version, Remarks, Role, ModifiedByAgentID, AgentID, DisciplineID, CreatedByAgentID, GiftID FROM giftagent WHERE GiftAgentID = ? ';

           if ($statement = $connection->prepare($preparesql)) { 
              $statement->bind_param("i", $this->GiftAgentID);
              $statement->execute();
              $statement->bind_result($this->GiftAgentID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Remarks, $this->Role, $this->ModifiedByAgentID, $this->AgentID, $this->DisciplineID, $this->CreatedByAgentID, $this->GiftID);
              $statement->fetch();
              $statement->close();
           }
   ...
   public function save() {
        ...
        if ($this->GiftAgentID!= NULL) {
            ...
            $sql .= "  WHERE GiftAgentID = ? ";
        } else {
            $sql  = 'INSERT INTO giftagent ';
            $isInsert = true;
if ($this->PK==NULL) { throw new Exception('Can\'t insert record with null primary key for this table'); }
            $sql .= '( GiftAgentID ,  TimestampCreated ,  TimestampModified ,  Version ,  Remarks ,  Role ,  ModifiedByAgentID ,  AgentID ,  DisciplineID ,  CreatedByAgentID ,  GiftID ) VALUES (';
            $sql .=  "  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
        ...
        if ($statement = $connection->prepare($sql)) { 
           if ($this->GiftAgentID!= NULL ) {
              $statement->bind_param("ississiiiiii", $this->GiftAgentID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->Remarks , $this->Role , $this->ModifiedByAgentID , $this->AgentID , $this->DisciplineID , $this->CreatedByAgentID , $this->GiftID , $this->GiftAgentID );
           } else { 
              $statement->bind_param("ississiiiii", $this->GiftAgentID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->Remarks , $this->Role , $this->ModifiedByAgentID , $this->AgentID , $this->DisciplineID , $this->CreatedByAgentID , $this->GiftID );
           } 
           $statement->execute();
   ...
   public function delete() {
        ...
        if($this->GiftAgentID != NULL) {
           ...
           $preparedsql = 'SELECT  FROM giftagent WHERE  and GiftAgentID = ?  ' ;
        if ($statement = $connection->prepare($preparedsql)) { 
           $statement->bind_param("ississiiiii", $this->GiftAgentID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Remarks, $this->Role, $this->ModifiedByAgentID, $this->AgentID, $this->DisciplineID, $this->CreatedByAgentID, $this->GiftID);
           $statement->execute();
           $statement->store_result();
           if ($statement->num_rows()==1) {
                $sql = 'DELETE FROM giftagent WHERE  and GiftAgentID = ?  ';
                if ($stmt_delete = $connection->prepare($sql)) { 
                   $stmt_delete->bind_param("ississiiiii", $this->GiftAgentID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->Remarks, $this->Role, $this->ModifiedByAgentID, $this->AgentID, $this->DisciplineID, $this->CreatedByAgentID, $this->GiftID);
   ...
   public function count() {
        ...
        global $connection;
        $returnvalue = false;
        $sql = 'SELECT count(*)  FROM giftagent';
   ...
   public function loadArrayKeyValueSearch($searchTermArray) {
       ...
       $sql = "SELECT GiftAgentID FROM giftagent $wherebit";
       if ($wherebit=='') { 
...
// TODO: *************** link to related tables 
  ...
  public function loadLinkedTo() { 
   ...
   public function keySelectAllConcatJSON($orderby='ASC') {
       ...
       $sql = "SELECT GiftAgentID, concat(IFNULL(TimestampCreated,'') || ' ' || IFNULL(TimestampModified,'') || ' ' || IFNULL(Version,'') || ' ' || IFNULL(Remarks,'') || ' ' || IFNULL(Role,'') || ' ' || IFNULL(ModifiedByAgentID,'') || ' ' || IFNULL(AgentID,'') || ' ' || IFNULL(DisciplineID,'') || ' ' || IFNULL(CreatedByAgentID,'') || ' ' || IFNULL(GiftID,'')) FROM giftagent order by Role, ModifiedByAgentID, AgentID, DisciplineID, CreatedByAgentID, GiftID $order ";
       $comma = '';
       if ($result = $connection->query($sql)) { 
   ...
   public function keySelectDistinctJSON($field,$orderby='ASC') {
       ...
       if ($this->hasField($field)) { 
          ...
          if ($orderby=='ASC') { $order = 'ASC'; } else { $order = 'DESC'; } 
          $preparemysql = "SELECT DISTINCT $fieldesc FROM giftagent order by $fieldesc $order ";
          $comma = '';
   ...
   public function loadArrayByRole($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT GiftAgentID FROM giftagent WHERE Role $operator '$searchTerm'";
        $preparedsql = "SELECT GiftAgentID FROM giftagent WHERE Role $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
   ...
   public function loadArrayByModifiedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT GiftAgentID FROM giftagent WHERE ModifiedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT GiftAgentID FROM giftagent WHERE ModifiedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT GiftAgentID FROM giftagent WHERE AgentID $operator '$searchTerm'";
        $preparedsql = "SELECT GiftAgentID FROM giftagent WHERE AgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByDisciplineID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT GiftAgentID FROM giftagent WHERE DisciplineID $operator '$searchTerm'";
        $preparedsql = "SELECT GiftAgentID FROM giftagent WHERE DisciplineID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByCreatedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT GiftAgentID FROM giftagent WHERE CreatedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT GiftAgentID FROM giftagent WHERE CreatedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByGiftID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT GiftAgentID FROM giftagent WHERE GiftID $operator '$searchTerm'";
        $preparedsql = "SELECT GiftAgentID FROM giftagent WHERE GiftID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function selectDistinctRole($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $sql = "SELECT count(*) as druid_ct, Role FROM giftagent group by Role order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctModifiedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, ModifiedByAgentID FROM giftagent group by ModifiedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' AgentID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, AgentID FROM giftagent group by AgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctDisciplineID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' DisciplineID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, DisciplineID FROM giftagent group by DisciplineID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctCreatedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, CreatedByAgentID FROM giftagent group by CreatedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctGiftID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' GiftID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, GiftID FROM giftagent group by GiftID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
...
// can use Druid to regenerate the giftagent.php file to reflect changes
// in the underlying database without overwriting your custom views of the data.
// 
class huh_giftagentView implements viewer
{
   var $model = null;
   ...
   public function getDetailsView($includeRelated=true, $editLinkURL='') {
       ...
       if ($editLinkURL!='') { 
          ...
          if (!$nullpk) { $returnvalue .= "<li>huh_giftagent <a href='$editLinkURL'>Edit</a></li>\n";  } 
       }
       $returnvalue .= "<li>".huh_giftagent::GIFTAGENTID.": ".$model->getGiftAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_giftagent::TIMESTAMPCREATED.": ".$model->getTimestampCreated()."</li>\n";
       $returnvalue .= "<li>".huh_giftagent::TIMESTAMPMODIFIED.": ".$model->getTimestampModified()."</li>\n";
       $returnvalue .= "<li>".huh_giftagent::VERSION.": ".$model->getVersion()."</li>\n";
       $returnvalue .= "<li>".huh_giftagent::REMARKS.": ".$model->getRemarks()."</li>\n";
       $returnvalue .= "<li>".huh_giftagent::ROLE.": ".$model->getRole()."</li>\n";
       $returnvalue .= "<li>".huh_giftagent::MODIFIEDBYAGENTID.": ".$model->getModifiedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_giftagent::AGENTID.": ".$model->getAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_giftagent::DISCIPLINEID.": ".$model->getDisciplineID()."</li>\n";
       $returnvalue .= "<li>".huh_giftagent::CREATEDBYAGENTID.": ".$model->getCreatedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_giftagent::GIFTID.": ".$model->getGiftID()."</li>\n";
       if ($includeRelated) { 
   ...
   public function getJSON() {
       $returnvalue = '{ ';
       $model = $this->model;
       $returnvalue .= '"'.huh_giftagent::GIFTAGENTID.': "'.$model->getGiftAgentID().'",';
       $returnvalue .= '"'.huh_giftagent::TIMESTAMPCREATED.': "'.$model->getTimestampCreated().'",';
       $returnvalue .= '"'.huh_giftagent::TIMESTAMPMODIFIED.': "'.$model->getTimestampModified().'",';
       $returnvalue .= '"'.huh_giftagent::VERSION.': "'.$model->getVersion().'",';
       $returnvalue .= '"'.huh_giftagent::REMARKS.': "'.$model->getRemarks().'",';
       $returnvalue .= '"'.huh_giftagent::ROLE.': "'.$model->getRole().'",';
       $returnvalue .= '"'.huh_giftagent::MODIFIEDBYAGENTID.': "'.$model->getModifiedByAgentID().'",';
       $returnvalue .= '"'.huh_giftagent::AGENTID.': "'.$model->getAgentID().'",';
       $returnvalue .= '"'.huh_giftagent::DISCIPLINEID.': "'.$model->getDisciplineID().'",';
       $returnvalue .= '"'.huh_giftagent::CREATEDBYAGENTID.': "'.$model->getCreatedByAgentID().'",';
       $returnvalue .= '"'.huh_giftagent::GIFTID.': "'.$model->getGiftID().'" }';
       $returnvalue .= '</ul>';
       return  $returnvalue;
   }
   public function getTableRowView() {
       $returnvalue = '<tr>';
       $model = $this->model;
       $returnvalue .= "<td>".$model->getGiftAgentID()."</td>\n";
   ...
   public function getHeaderRow() {
       $returnvalue = '<tr>';
       $returnvalue .= "<th>".huh_giftagent::GIFTAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_giftagent::TIMESTAMPCREATED."</th>\n";
       $returnvalue .= "<th>".huh_giftagent::TIMESTAMPMODIFIED."</th>\n";
       $returnvalue .= "<th>".huh_giftagent::VERSION."</th>\n";
       $returnvalue .= "<th>".huh_giftagent::REMARKS."</th>\n";
       $returnvalue .= "<th>".huh_giftagent::ROLE."</th>\n";
       $returnvalue .= "<th>".huh_giftagent::MODIFIEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_giftagent::AGENTID."</th>\n";
       $returnvalue .= "<th>".huh_giftagent::DISCIPLINEID."</th>\n";
       $returnvalue .= "<th>".huh_giftagent::CREATEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_giftagent::GIFTID."</th>\n";
       $returnvalue .= '</tr>';
       return  $returnvalue;
   }
  ...
  function save'.$id.'() {
     ...
     dojo.xhrGet(saveprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_giftagent">';
       $returnvalue .= "<div id='div_$formnane' >";
       if($addform) { 
          $returnvalue .= "Add a new GiftAgentID"; 
       } else { 
         $returnvalue .= "<div><label for=".huh_giftagent::GIFTAGENTID.">GIFTAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_giftagent::GIFTAGENTID." id=".huh_giftagent::GIFTAGENTID." value='".$model->getGiftAgentID()."'  style=' width:".huh_giftagent::GIFTAGENTID_SIZE ."em;  '  maxlength='".huh_giftagent::GIFTAGENTID_SIZE ."' ></div>\n";
       }  
       $returnvalue .= "<div><label for=".huh_giftagent::TIMESTAMPCREATED.">TIMESTAMPCREATED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_giftagent::TIMESTAMPCREATED." id=".huh_giftagent::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  style=' width:".huh_giftagent::TIMESTAMPCREATED_SIZE ."em;  '  maxlength='".huh_giftagent::TIMESTAMPCREATED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_giftagent::TIMESTAMPMODIFIED.">TIMESTAMPMODIFIED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_giftagent::TIMESTAMPMODIFIED." id=".huh_giftagent::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  style=' width:".huh_giftagent::TIMESTAMPMODIFIED_SIZE ."em;  '  maxlength='".huh_giftagent::TIMESTAMPMODIFIED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_giftagent::VERSION.">VERSION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_giftagent::VERSION." id=".huh_giftagent::VERSION." value='".$model->getVersion()."'  style=' width:".huh_giftagent::VERSION_SIZE ."em;  '  maxlength='".huh_giftagent::VERSION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_giftagent::REMARKS.">REMARKS</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_giftagent::REMARKS." id=".huh_giftagent::REMARKS." >".$model->getRemarks()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_giftagent::ROLE.">ROLE</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_giftagent::ROLE." id=".huh_giftagent::ROLE." value='".$model->getRole()."'  style=' width:".huh_giftagent::ROLE_SIZE ."em;  '  maxlength='".huh_giftagent::ROLE_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_giftagent::MODIFIEDBYAGENTID.">MODIFIEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_giftagent::MODIFIEDBYAGENTID." id=".huh_giftagent::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  style=' width:".huh_giftagent::MODIFIEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_giftagent::MODIFIEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_giftagent::AGENTID.">AGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_giftagent::AGENTID." id=".huh_giftagent::AGENTID." value='".$model->getAgentID()."'  style=' width:".huh_giftagent::AGENTID_SIZE ."em;  '  maxlength='".huh_giftagent::AGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_giftagent::DISCIPLINEID.">DISCIPLINEID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_giftagent::DISCIPLINEID." id=".huh_giftagent::DISCIPLINEID." value='".$model->getDisciplineID()."'  style=' width:".huh_giftagent::DISCIPLINEID_SIZE ."em;  '  maxlength='".huh_giftagent::DISCIPLINEID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_giftagent::CREATEDBYAGENTID.">CREATEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_giftagent::CREATEDBYAGENTID." id=".huh_giftagent::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  style=' width:".huh_giftagent::CREATEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_giftagent::CREATEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_giftagent::GIFTID.">GIFTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_giftagent::GIFTID." id=".huh_giftagent::GIFTID." value='".$model->getGiftID()."'  style=' width:".huh_giftagent::GIFTID_SIZE ."em;  '  maxlength='".huh_giftagent::GIFTID_SIZE ."' ></div>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
  ...
  function deleterecord'.$id.'() {
     ...
     dojo.xhrGet(deleteprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_table value="huh_giftagent">';
       $returnvalue .= '<input type=hidden name=GiftAgentID id=druid_table value="'.$id.'">';
       $returnvalue .= '<ul>';
   ...
   public function getEditFormView($includeRelated=true) {
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_giftagent">';
       $returnvalue .= '<ul>';
       $returnvalue .= "<li>GIFTAGENTID<input type=text name=".huh_giftagent::GIFTAGENTID." id=".huh_giftagent::GIFTAGENTID." value='".$model->getGiftAgentID()."'  size='".huh_giftagent::GIFTAGENTID_SIZE ."'  maxlength='".huh_giftagent::GIFTAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPCREATED<input type=text name=".huh_giftagent::TIMESTAMPCREATED." id=".huh_giftagent::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  size='".huh_giftagent::TIMESTAMPCREATED_SIZE ."'  maxlength='".huh_giftagent::TIMESTAMPCREATED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPMODIFIED<input type=text name=".huh_giftagent::TIMESTAMPMODIFIED." id=".huh_giftagent::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  size='".huh_giftagent::TIMESTAMPMODIFIED_SIZE ."'  maxlength='".huh_giftagent::TIMESTAMPMODIFIED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>VERSION<input type=text name=".huh_giftagent::VERSION." id=".huh_giftagent::VERSION." value='".$model->getVersion()."'  size='".huh_giftagent::VERSION_SIZE ."'  maxlength='".huh_giftagent::VERSION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>REMARKS<input type=text name=".huh_giftagent::REMARKS." id=".huh_giftagent::REMARKS." value='".$model->getRemarks()."'  size='51'  maxlength='".huh_giftagent::REMARKS_SIZE ."' ></li>\n";
       $returnvalue .= "<li>ROLE<input type=text name=".huh_giftagent::ROLE." id=".huh_giftagent::ROLE." value='".$model->getRole()."'  size='".huh_giftagent::ROLE_SIZE ."'  maxlength='".huh_giftagent::ROLE_SIZE ."' ></li>\n";
       $returnvalue .= "<li>MODIFIEDBYAGENTID<input type=text name=".huh_giftagent::MODIFIEDBYAGENTID." id=".huh_giftagent::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  size='".huh_giftagent::MODIFIEDBYAGENTID_SIZE ."'  maxlength='".huh_giftagent::MODIFIEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>AGENTID<input type=text name=".huh_giftagent::AGENTID." id=".huh_giftagent::AGENTID." value='".$model->getAgentID()."'  size='".huh_giftagent::AGENTID_SIZE ."'  maxlength='".huh_giftagent::AGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>DISCIPLINEID<input type=text name=".huh_giftagent::DISCIPLINEID." id=".huh_giftagent::DISCIPLINEID." value='".$model->getDisciplineID()."'  size='".huh_giftagent::DISCIPLINEID_SIZE ."'  maxlength='".huh_giftagent::DISCIPLINEID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>CREATEDBYAGENTID<input type=text name=".huh_giftagent::CREATEDBYAGENTID." id=".huh_giftagent::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  size='".huh_giftagent::CREATEDBYAGENTID_SIZE ."'  maxlength='".huh_giftagent::CREATEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>GIFTID<input type=text name=".huh_giftagent::GIFTID." id=".huh_giftagent::GIFTID." value='".$model->getGiftID()."'  size='".huh_giftagent::GIFTID_SIZE ."'  maxlength='".huh_giftagent::GIFTID_SIZE ."' ></li>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
