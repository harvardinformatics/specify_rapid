...
class huh_borrowagent implements  model , loadableModel, saveableModel, tableSchema 
{
   // These constants hold the sizes the fields in this table in the database.
   const BORROWAGENTID_SIZE   = 11; //INTEGER
   ...
   const BORROWAGENTID     = 'BorrowAgentID';
...
/*  Customize these to limit each variable to narrowest possible set of known good values. 
  ...
  $BorrowAgentID = substr(preg_replace('/[^0-9\-\[NULL\]]/','',$_GET['BorrowAgentID']), 0, 11);
  ...
  $Role = substr(preg_replace('/[^A-Za-z0-9\.\.\ \[NULL\]]/','',$_GET['Role']), 0, 32);
...
*/
   ...
   private $BorrowAgentID; // PK INTEGER 
   ...
   private $loaded;
   private $error;
   const FIELDLIST = ' BorrowAgentID, TimestampCreated, TimestampModified, Version, CollectionMemberID, Remarks, Role, ModifiedByAgentID, BorrowID, AgentID, CreatedByAgentID, ';
   const PKFIELDLIST = ' BorrowAgentID, ';
   const NUMBER_OF_PRIMARY_KEYS = 1;
   private $primaryKeyArray = array( 1 => 'BorrowAgentID'  ) ;
   private $allFieldsArray = array( 0 => 'BorrowAgentID' , 1 => 'TimestampCreated' , 2 => 'TimestampModified' , 3 => 'Version' , 4 => 'CollectionMemberID' , 5 => 'Remarks' , 6 => 'Role' , 7 => 'ModifiedByAgentID' , 8 => 'BorrowID' , 9 => 'AgentID' , 10 => 'CreatedByAgentID'  ) ;
   private $selectDistinctFieldsArray = array( 4 => 'CollectionMemberID' , 6 => 'Role' , 7 => 'ModifiedByAgentID' , 8 => 'BorrowID' , 9 => 'AgentID' , 10 => 'CreatedByAgentID'  ) ;

   //---------------------------------------------------------------------------

   // constructor 
   function huh_borrowagent(){
   ...
   public function keyValueSet($fieldname,$value) {
       ...
       if ($this->hasField($fieldname)) { 
          try {
             if ($fieldname=='BorrowAgentID') { $returnvalue = $this->setBorrowAgentID($value); } 
   ...
   public function keyGet($fieldname) {
       ...
       if ($this->hasField($fieldname)) { 
          try {
             if ($fieldname=='BorrowAgentID') { $returnvalue = $this->getBorrowAgentID(); } 
...
/*BorrowAgentID*/
   public function getBorrowAgentID() {
       if ($this->BorrowAgentID==null) { 
          return null;
       } else { ;
          return trim($this->l_stripslashes($this->BorrowAgentID));
       }
   }
   public function setBorrowAgentID($BorrowAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$BorrowAgentID)) > huh_borrowagent::BORROWAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
       $BorrowAgentID = trim($BorrowAgentID);
       if (!ctype_digit(strval($BorrowAgentID)) && trim(strval($BorrowAgentID))!='' ) {
             throw new Exception("Value must be an integer");
       }
       $this->BorrowAgentID = $this->l_addslashes($BorrowAgentID);
       $this->dirty = true;
   }
/*TimestampCreated*/
   ...
   public function setTimestampCreated($TimestampCreated) {
       if (strlen($TimestampCreated) > huh_borrowagent::TIMESTAMPCREATED_SIZE) { 
...
/*TimestampModified*/
   ...
   public function setTimestampModified($TimestampModified) {
       if (strlen($TimestampModified) > huh_borrowagent::TIMESTAMPMODIFIED_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Version*/
   ...
   public function setVersion($Version) {
       if (strlen(preg_replace('/[^0-9]/','',$Version)) > huh_borrowagent::VERSION_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*CollectionMemberID*/
   ...
   public function setCollectionMemberID($CollectionMemberID) {
       if (strlen(preg_replace('/[^0-9]/','',$CollectionMemberID)) > huh_borrowagent::COLLECTIONMEMBERID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*Remarks*/
   ...
   public function setRemarks($Remarks) {
       if (strlen($Remarks) > huh_borrowagent::REMARKS_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*Role*/
   ...
   public function setRole($Role) {
       if (strlen($Role) > huh_borrowagent::ROLE_SIZE) { 
           throw new Exception('Value exceeds field length.');
       } 
...
/*ModifiedByAgentID*/
   ...
   public function setModifiedByAgentID($ModifiedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$ModifiedByAgentID)) > huh_borrowagent::MODIFIEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*BorrowID*/
   ...
   public function setBorrowID($BorrowID) {
       if (strlen(preg_replace('/[^0-9]/','',$BorrowID)) > huh_borrowagent::BORROWID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*AgentID*/
   ...
   public function setAgentID($AgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$AgentID)) > huh_borrowagent::AGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
...
/*CreatedByAgentID*/
   ...
   public function setCreatedByAgentID($CreatedByAgentID) {
       if (strlen(preg_replace('/[^0-9]/','',$CreatedByAgentID)) > huh_borrowagent::CREATEDBYAGENTID_SIZE) { 
           throw new Exception('Value has too many digits for the field length.');
       } 
   ...
   public function PK() { // get value of primary key 
        $returnvalue = '';
        $returnvalue .= $this->getBorrowAgentID();
        return $returnvalue;
   }
   public function PKArray() { // get name and value of primary key fields 
        $returnvalue = array();
        $returnvalue['BorrowAgentID'] = $this->getBorrowAgentID();
        return $returnvalue;
   }
  ...
  const C_BorrowAgentIDMYSQLI_TYPE = 'i';
  ...
  const C_CreatedByAgentIDMYSQLI_TYPE = 'i';
   ...
   public function MySQLiFieldType($aFieldname) { 
      $retval = '';
      if ($aFieldname=='BorrowAgentID') { $retval = self::C_BorrowAgentIDMYSQLI_TYPE; }
   ...
   public function load($pk) {
        ...
        try {
             if (is_array($pk)) { 
                 $this->setBorrowAgentID($pk[BorrowAgentID]);
             } else { ;
                 $this->setBorrowAgentID($pk);
             };
        } 
        catch (Exception $e) { 
        ...
        if($this->BorrowAgentID != NULL) {
           $sql = 'SELECT BorrowAgentID, TimestampCreated, TimestampModified, Version, CollectionMemberID, Remarks, Role, ModifiedByAgentID, BorrowID, AgentID, CreatedByAgentID FROM borrowagent WHERE BorrowAgentID = '.$this->BorrowAgentID ;

           $preparesql = 'SELECT BorrowAgentID, TimestampCreated, TimestampModified, Version, CollectionMemberID, Remarks, Role, ModifiedByAgentID, BorrowID, AgentID, CreatedByAgentID FROM borrowagent WHERE BorrowAgentID = ? ';

           if ($statement = $connection->prepare($preparesql)) { 
              $statement->bind_param("i", $this->BorrowAgentID);
              $statement->execute();
              $statement->bind_result($this->BorrowAgentID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->CollectionMemberID, $this->Remarks, $this->Role, $this->ModifiedByAgentID, $this->BorrowID, $this->AgentID, $this->CreatedByAgentID);
              $statement->fetch();
              $statement->close();
           }
   ...
   public function save() {
        ...
        if ($this->BorrowAgentID!= NULL) {
            ...
            $sql .= "  WHERE BorrowAgentID = ? ";
        } else {
            $sql  = 'INSERT INTO borrowagent ';
            $isInsert = true;
if ($this->PK==NULL) { throw new Exception('Can\'t insert record with null primary key for this table'); }
            $sql .= '( BorrowAgentID ,  TimestampCreated ,  TimestampModified ,  Version ,  CollectionMemberID ,  Remarks ,  Role ,  ModifiedByAgentID ,  BorrowID ,  AgentID ,  CreatedByAgentID ) VALUES (';
            $sql .=  "  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
            $sql .=  " ,  ? ";
        ...
        if ($statement = $connection->prepare($sql)) { 
           if ($this->BorrowAgentID!= NULL ) {
              $statement->bind_param("issiissiiiii", $this->BorrowAgentID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->CollectionMemberID , $this->Remarks , $this->Role , $this->ModifiedByAgentID , $this->BorrowID , $this->AgentID , $this->CreatedByAgentID , $this->BorrowAgentID );
           } else { 
              $statement->bind_param("issiissiiii", $this->BorrowAgentID , $this->TimestampCreated , $this->TimestampModified , $this->Version , $this->CollectionMemberID , $this->Remarks , $this->Role , $this->ModifiedByAgentID , $this->BorrowID , $this->AgentID , $this->CreatedByAgentID );
           } 
           $statement->execute();
   ...
   public function delete() {
        ...
        if($this->BorrowAgentID != NULL) {
           ...
           $preparedsql = 'SELECT  FROM borrowagent WHERE  and BorrowAgentID = ?  ' ;
        if ($statement = $connection->prepare($preparedsql)) { 
           $statement->bind_param("issiissiiii", $this->BorrowAgentID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->CollectionMemberID, $this->Remarks, $this->Role, $this->ModifiedByAgentID, $this->BorrowID, $this->AgentID, $this->CreatedByAgentID);
           $statement->execute();
           $statement->store_result();
           if ($statement->num_rows()==1) {
                $sql = 'DELETE FROM borrowagent WHERE  and BorrowAgentID = ?  ';
                if ($stmt_delete = $connection->prepare($sql)) { 
                   $stmt_delete->bind_param("issiissiiii", $this->BorrowAgentID, $this->TimestampCreated, $this->TimestampModified, $this->Version, $this->CollectionMemberID, $this->Remarks, $this->Role, $this->ModifiedByAgentID, $this->BorrowID, $this->AgentID, $this->CreatedByAgentID);
   ...
   public function count() {
        ...
        global $connection;
        $returnvalue = false;
        $sql = 'SELECT count(*)  FROM borrowagent';
   ...
   public function loadArrayKeyValueSearch($searchTermArray) {
       ...
       $sql = "SELECT BorrowAgentID FROM borrowagent $wherebit";
       if ($wherebit=='') { 
...
// TODO: *************** link to related tables 
  ...
  public function loadLinkedTo() { 
   ...
   public function keySelectAllConcatJSON($orderby='ASC') {
       ...
       $sql = "SELECT BorrowAgentID, concat(IFNULL(TimestampCreated,'') || ' ' || IFNULL(TimestampModified,'') || ' ' || IFNULL(Version,'') || ' ' || IFNULL(CollectionMemberID,'') || ' ' || IFNULL(Remarks,'') || ' ' || IFNULL(Role,'') || ' ' || IFNULL(ModifiedByAgentID,'') || ' ' || IFNULL(BorrowID,'') || ' ' || IFNULL(AgentID,'') || ' ' || IFNULL(CreatedByAgentID,'')) FROM borrowagent order by CollectionMemberID, Role, ModifiedByAgentID, BorrowID, AgentID, CreatedByAgentID $order ";
       $comma = '';
       if ($result = $connection->query($sql)) { 
   ...
   public function keySelectDistinctJSON($field,$orderby='ASC') {
       ...
       if ($this->hasField($field)) { 
          ...
          if ($orderby=='ASC') { $order = 'ASC'; } else { $order = 'DESC'; } 
          $preparemysql = "SELECT DISTINCT $fieldesc FROM borrowagent order by $fieldesc $order ";
          $comma = '';
   ...
   public function loadArrayByCollectionMemberID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT BorrowAgentID FROM borrowagent WHERE CollectionMemberID $operator '$searchTerm'";
        $preparedsql = "SELECT BorrowAgentID FROM borrowagent WHERE CollectionMemberID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
   ...
   public function loadArrayByRole($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT BorrowAgentID FROM borrowagent WHERE Role $operator '$searchTerm'";
        $preparedsql = "SELECT BorrowAgentID FROM borrowagent WHERE Role $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByModifiedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT BorrowAgentID FROM borrowagent WHERE ModifiedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT BorrowAgentID FROM borrowagent WHERE ModifiedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByBorrowID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT BorrowAgentID FROM borrowagent WHERE BorrowID $operator '$searchTerm'";
        $preparedsql = "SELECT BorrowAgentID FROM borrowagent WHERE BorrowID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT BorrowAgentID FROM borrowagent WHERE AgentID $operator '$searchTerm'";
        $preparedsql = "SELECT BorrowAgentID FROM borrowagent WHERE AgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function loadArrayByCreatedByAgentID($searchTerm) {
        ...
        if (!(strpos($searchTerm,"%")===false)) { $operator = "like"; }
        if (!(strpos($searchTerm,"_")===false)) { $operator = "like"; }
        $sql = "SELECT BorrowAgentID FROM borrowagent WHERE CreatedByAgentID $operator '$searchTerm'";
        $preparedsql = "SELECT BorrowAgentID FROM borrowagent WHERE CreatedByAgentID $operator ? ";
        if ($statement = $connection->prepare($preparedsql)) { 
            $statement->bind_param("s", $searchTerm);
            $statement->execute();
            $statement->bind_result($id);
   ...
   public function selectDistinctCollectionMemberID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $sql = "SELECT count(*) as druid_ct, CollectionMemberID FROM borrowagent group by CollectionMemberID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctRole($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' Role ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, Role FROM borrowagent group by Role order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctModifiedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, ModifiedByAgentID FROM borrowagent group by ModifiedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctBorrowID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' BorrowID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, BorrowID FROM borrowagent group by BorrowID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        $order = ' AgentID ';
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, AgentID FROM borrowagent group by AgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
   ...
   public function selectDistinctCreatedByAgentID($startline,$link,$endline,$includecount=false,$orderbycount=false) {
        ...
        if ($orderbycount) { $order = ' druid_ct DESC '; } 
        $sql = "SELECT count(*) as druid_ct, CreatedByAgentID FROM borrowagent group by CreatedByAgentID order by $order ";
        if ($result = $connection->query($sql)) { 
           while ($row = $result->fetch_row()) {
              if ($row) {
                  $count = $row[0];
...
// can use Druid to regenerate the borrowagent.php file to reflect changes
// in the underlying database without overwriting your custom views of the data.
// 
class huh_borrowagentView implements viewer
{
   var $model = null;
   ...
   public function getDetailsView($includeRelated=true, $editLinkURL='') {
       ...
       if ($editLinkURL!='') { 
          ...
          if (!$nullpk) { $returnvalue .= "<li>huh_borrowagent <a href='$editLinkURL'>Edit</a></li>\n";  } 
       }
       $returnvalue .= "<li>".huh_borrowagent::BORROWAGENTID.": ".$model->getBorrowAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_borrowagent::TIMESTAMPCREATED.": ".$model->getTimestampCreated()."</li>\n";
       $returnvalue .= "<li>".huh_borrowagent::TIMESTAMPMODIFIED.": ".$model->getTimestampModified()."</li>\n";
       $returnvalue .= "<li>".huh_borrowagent::VERSION.": ".$model->getVersion()."</li>\n";
       $returnvalue .= "<li>".huh_borrowagent::COLLECTIONMEMBERID.": ".$model->getCollectionMemberID()."</li>\n";
       $returnvalue .= "<li>".huh_borrowagent::REMARKS.": ".$model->getRemarks()."</li>\n";
       $returnvalue .= "<li>".huh_borrowagent::ROLE.": ".$model->getRole()."</li>\n";
       $returnvalue .= "<li>".huh_borrowagent::MODIFIEDBYAGENTID.": ".$model->getModifiedByAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_borrowagent::BORROWID.": ".$model->getBorrowID()."</li>\n";
       $returnvalue .= "<li>".huh_borrowagent::AGENTID.": ".$model->getAgentID()."</li>\n";
       $returnvalue .= "<li>".huh_borrowagent::CREATEDBYAGENTID.": ".$model->getCreatedByAgentID()."</li>\n";
       if ($includeRelated) { 
   ...
   public function getJSON() {
       $returnvalue = '{ ';
       $model = $this->model;
       $returnvalue .= '"'.huh_borrowagent::BORROWAGENTID.': "'.$model->getBorrowAgentID().'",';
       $returnvalue .= '"'.huh_borrowagent::TIMESTAMPCREATED.': "'.$model->getTimestampCreated().'",';
       $returnvalue .= '"'.huh_borrowagent::TIMESTAMPMODIFIED.': "'.$model->getTimestampModified().'",';
       $returnvalue .= '"'.huh_borrowagent::VERSION.': "'.$model->getVersion().'",';
       $returnvalue .= '"'.huh_borrowagent::COLLECTIONMEMBERID.': "'.$model->getCollectionMemberID().'",';
       $returnvalue .= '"'.huh_borrowagent::REMARKS.': "'.$model->getRemarks().'",';
       $returnvalue .= '"'.huh_borrowagent::ROLE.': "'.$model->getRole().'",';
       $returnvalue .= '"'.huh_borrowagent::MODIFIEDBYAGENTID.': "'.$model->getModifiedByAgentID().'",';
       $returnvalue .= '"'.huh_borrowagent::BORROWID.': "'.$model->getBorrowID().'",';
       $returnvalue .= '"'.huh_borrowagent::AGENTID.': "'.$model->getAgentID().'",';
       $returnvalue .= '"'.huh_borrowagent::CREATEDBYAGENTID.': "'.$model->getCreatedByAgentID().'" }';
       $returnvalue .= '</ul>';
       return  $returnvalue;
   }
   public function getTableRowView() {
       $returnvalue = '<tr>';
       $model = $this->model;
       $returnvalue .= "<td>".$model->getBorrowAgentID()."</td>\n";
   ...
   public function getHeaderRow() {
       $returnvalue = '<tr>';
       $returnvalue .= "<th>".huh_borrowagent::BORROWAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_borrowagent::TIMESTAMPCREATED."</th>\n";
       $returnvalue .= "<th>".huh_borrowagent::TIMESTAMPMODIFIED."</th>\n";
       $returnvalue .= "<th>".huh_borrowagent::VERSION."</th>\n";
       $returnvalue .= "<th>".huh_borrowagent::COLLECTIONMEMBERID."</th>\n";
       $returnvalue .= "<th>".huh_borrowagent::REMARKS."</th>\n";
       $returnvalue .= "<th>".huh_borrowagent::ROLE."</th>\n";
       $returnvalue .= "<th>".huh_borrowagent::MODIFIEDBYAGENTID."</th>\n";
       $returnvalue .= "<th>".huh_borrowagent::BORROWID."</th>\n";
       $returnvalue .= "<th>".huh_borrowagent::AGENTID."</th>\n";
       $returnvalue .= "<th>".huh_borrowagent::CREATEDBYAGENTID."</th>\n";
       $returnvalue .= '</tr>';
       return  $returnvalue;
   }
  ...
  function save'.$id.'() {
     ...
     dojo.xhrGet(saveprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_borrowagent">';
       $returnvalue .= "<div id='div_$formnane' >";
       if($addform) { 
          $returnvalue .= "Add a new BorrowAgentID"; 
       } else { 
         $returnvalue .= "<div><label for=".huh_borrowagent::BORROWAGENTID.">BORROWAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_borrowagent::BORROWAGENTID." id=".huh_borrowagent::BORROWAGENTID." value='".$model->getBorrowAgentID()."'  style=' width:".huh_borrowagent::BORROWAGENTID_SIZE ."em;  '  maxlength='".huh_borrowagent::BORROWAGENTID_SIZE ."' ></div>\n";
       }  
       $returnvalue .= "<div><label for=".huh_borrowagent::TIMESTAMPCREATED.">TIMESTAMPCREATED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_borrowagent::TIMESTAMPCREATED." id=".huh_borrowagent::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  style=' width:".huh_borrowagent::TIMESTAMPCREATED_SIZE ."em;  '  maxlength='".huh_borrowagent::TIMESTAMPCREATED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_borrowagent::TIMESTAMPMODIFIED.">TIMESTAMPMODIFIED</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_borrowagent::TIMESTAMPMODIFIED." id=".huh_borrowagent::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  style=' width:".huh_borrowagent::TIMESTAMPMODIFIED_SIZE ."em;  '  maxlength='".huh_borrowagent::TIMESTAMPMODIFIED_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_borrowagent::VERSION.">VERSION</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_borrowagent::VERSION." id=".huh_borrowagent::VERSION." value='".$model->getVersion()."'  style=' width:".huh_borrowagent::VERSION_SIZE ."em;  '  maxlength='".huh_borrowagent::VERSION_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_borrowagent::COLLECTIONMEMBERID.">COLLECTIONMEMBERID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_borrowagent::COLLECTIONMEMBERID." id=".huh_borrowagent::COLLECTIONMEMBERID." value='".$model->getCollectionMemberID()."'  style=' width:".huh_borrowagent::COLLECTIONMEMBERID_SIZE ."em;  '  maxlength='".huh_borrowagent::COLLECTIONMEMBERID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_borrowagent::REMARKS.">REMARKS</label><textarea  dojoType='dijit.form.Textarea'  style=' width:51em; border:1px solid grey; '  name=".huh_borrowagent::REMARKS." id=".huh_borrowagent::REMARKS." >".$model->getRemarks()."</textarea></div>\n";
       $returnvalue .= "<div><label for=".huh_borrowagent::ROLE.">ROLE</label><input  dojoType='dijit.form.ValidationTextBox'  name=".huh_borrowagent::ROLE." id=".huh_borrowagent::ROLE." value='".$model->getRole()."'  style=' width:".huh_borrowagent::ROLE_SIZE ."em;  '  maxlength='".huh_borrowagent::ROLE_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_borrowagent::MODIFIEDBYAGENTID.">MODIFIEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_borrowagent::MODIFIEDBYAGENTID." id=".huh_borrowagent::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  style=' width:".huh_borrowagent::MODIFIEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_borrowagent::MODIFIEDBYAGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_borrowagent::BORROWID.">BORROWID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_borrowagent::BORROWID." id=".huh_borrowagent::BORROWID." value='".$model->getBorrowID()."'  style=' width:".huh_borrowagent::BORROWID_SIZE ."em;  '  maxlength='".huh_borrowagent::BORROWID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_borrowagent::AGENTID.">AGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_borrowagent::AGENTID." id=".huh_borrowagent::AGENTID." value='".$model->getAgentID()."'  style=' width:".huh_borrowagent::AGENTID_SIZE ."em;  '  maxlength='".huh_borrowagent::AGENTID_SIZE ."' ></div>\n";
       $returnvalue .= "<div><label for=".huh_borrowagent::CREATEDBYAGENTID.">CREATEDBYAGENTID</label><input  dojoType='dijit.form.ValidationTextBox'  regExp='^[0-9-]*'  invalidMessage='The value entered is not valid.  It must be an integer.' name=".huh_borrowagent::CREATEDBYAGENTID." id=".huh_borrowagent::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  style=' width:".huh_borrowagent::CREATEDBYAGENTID_SIZE ."em;  '  maxlength='".huh_borrowagent::CREATEDBYAGENTID_SIZE ."' ></div>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
  ...
  function deleterecord'.$id.'() {
     ...
     dojo.xhrGet(deleteprocessor'.$id.');
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_table value="huh_borrowagent">';
       $returnvalue .= '<input type=hidden name=BorrowAgentID id=druid_table value="'.$id.'">';
       $returnvalue .= '<ul>';
   ...
   public function getEditFormView($includeRelated=true) {
       ...
       $returnvalue .= '<input type=hidden name=druid_table id=druid_action value="huh_borrowagent">';
       $returnvalue .= '<ul>';
       $returnvalue .= "<li>BORROWAGENTID<input type=text name=".huh_borrowagent::BORROWAGENTID." id=".huh_borrowagent::BORROWAGENTID." value='".$model->getBorrowAgentID()."'  size='".huh_borrowagent::BORROWAGENTID_SIZE ."'  maxlength='".huh_borrowagent::BORROWAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPCREATED<input type=text name=".huh_borrowagent::TIMESTAMPCREATED." id=".huh_borrowagent::TIMESTAMPCREATED." value='".$model->getTimestampCreated()."'  size='".huh_borrowagent::TIMESTAMPCREATED_SIZE ."'  maxlength='".huh_borrowagent::TIMESTAMPCREATED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>TIMESTAMPMODIFIED<input type=text name=".huh_borrowagent::TIMESTAMPMODIFIED." id=".huh_borrowagent::TIMESTAMPMODIFIED." value='".$model->getTimestampModified()."'  size='".huh_borrowagent::TIMESTAMPMODIFIED_SIZE ."'  maxlength='".huh_borrowagent::TIMESTAMPMODIFIED_SIZE ."' ></li>\n";
       $returnvalue .= "<li>VERSION<input type=text name=".huh_borrowagent::VERSION." id=".huh_borrowagent::VERSION." value='".$model->getVersion()."'  size='".huh_borrowagent::VERSION_SIZE ."'  maxlength='".huh_borrowagent::VERSION_SIZE ."' ></li>\n";
       $returnvalue .= "<li>COLLECTIONMEMBERID<input type=text name=".huh_borrowagent::COLLECTIONMEMBERID." id=".huh_borrowagent::COLLECTIONMEMBERID." value='".$model->getCollectionMemberID()."'  size='".huh_borrowagent::COLLECTIONMEMBERID_SIZE ."'  maxlength='".huh_borrowagent::COLLECTIONMEMBERID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>REMARKS<input type=text name=".huh_borrowagent::REMARKS." id=".huh_borrowagent::REMARKS." value='".$model->getRemarks()."'  size='51'  maxlength='".huh_borrowagent::REMARKS_SIZE ."' ></li>\n";
       $returnvalue .= "<li>ROLE<input type=text name=".huh_borrowagent::ROLE." id=".huh_borrowagent::ROLE." value='".$model->getRole()."'  size='".huh_borrowagent::ROLE_SIZE ."'  maxlength='".huh_borrowagent::ROLE_SIZE ."' ></li>\n";
       $returnvalue .= "<li>MODIFIEDBYAGENTID<input type=text name=".huh_borrowagent::MODIFIEDBYAGENTID." id=".huh_borrowagent::MODIFIEDBYAGENTID." value='".$model->getModifiedByAgentID()."'  size='".huh_borrowagent::MODIFIEDBYAGENTID_SIZE ."'  maxlength='".huh_borrowagent::MODIFIEDBYAGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>BORROWID<input type=text name=".huh_borrowagent::BORROWID." id=".huh_borrowagent::BORROWID." value='".$model->getBorrowID()."'  size='".huh_borrowagent::BORROWID_SIZE ."'  maxlength='".huh_borrowagent::BORROWID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>AGENTID<input type=text name=".huh_borrowagent::AGENTID." id=".huh_borrowagent::AGENTID." value='".$model->getAgentID()."'  size='".huh_borrowagent::AGENTID_SIZE ."'  maxlength='".huh_borrowagent::AGENTID_SIZE ."' ></li>\n";
       $returnvalue .= "<li>CREATEDBYAGENTID<input type=text name=".huh_borrowagent::CREATEDBYAGENTID." id=".huh_borrowagent::CREATEDBYAGENTID." value='".$model->getCreatedByAgentID()."'  size='".huh_borrowagent::CREATEDBYAGENTID_SIZE ."'  maxlength='".huh_borrowagent::CREATEDBYAGENTID_SIZE ."' ></li>\n";
       if ($includeRelated) { 
           // note that $includeRelated is provided as false in calls out to
           // related tables to prevent infinite loops between related objects.
        }
